...
const (
	...
	WorldDataNotify_CMD_ID           WorldDataNotify_CmdId = 3013
...
func (WorldDataNotify_DataType) Descriptor() protoreflect.EnumDescriptor {
	return file_WorldDataNotify_proto_enumTypes[1].Descriptor()
}

func (WorldDataNotify_DataType) Type() protoreflect.EnumType {
	return &file_WorldDataNotify_proto_enumTypes[1]
}
...
func (WorldDataNotify_DataType) EnumDescriptor() ([]byte, []int) {
	return file_WorldDataNotify_proto_rawDescGZIP(), []int{0, 1}
}
...
type WorldDataNotify struct {
	...
	WorldPropMap map[uint32]*PropValue `protobuf:"bytes,1,rep,name=world_prop_map,json=worldPropMap,proto3" json:"world_prop_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_WorldDataNotify_proto_rawDesc = []byte{
	...
	0xc4, 0x02, 0x0a, 0x0f, 0x57, 0x6f, 0x72, 0x6c, 0x64, 0x44, 0x61, 0x74, 0x61, 0x4e, 0x6f, 0x74,
	0x69, 0x66, 0x79, 0x12, 0x4e, 0x0a, 0x0e, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x5f, 0x70, 0x72, 0x6f,
	0x70, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x70, 0x72,
	...
	0x5f, 0x49, 0x44, 0x10, 0xc5, 0x17, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f, 0x43,
	...
	0x49, 0x45, 0x4e, 0x54, 0x10, 0x01, 0x1a, 0x02, 0x10, 0x01, 0x22, 0x2a, 0x0a, 0x08, 0x44, 0x61,
	0x74, 0x61, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0d, 0x0a, 0x09, 0x44, 0x41, 0x54, 0x41, 0x5f, 0x4e,
	0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0f, 0x0a, 0x0b, 0x57, 0x4f, 0x52, 0x4c, 0x44, 0x5f, 0x4c,
	0x45, 0x56, 0x45, 0x4c, 0x10, 0x01, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x3b, 0x70, 0x72, 0x6f,
...
var file_WorldDataNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_WorldDataNotify_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_WorldDataNotify_proto_goTypes = []interface{}{
	(WorldDataNotify_CmdId)(0),    // 0: proto.WorldDataNotify.CmdId
	(WorldDataNotify_DataType)(0), // 1: proto.WorldDataNotify.DataType
	(*WorldDataNotify)(nil),       // 2: proto.WorldDataNotify
	nil,                           // 3: proto.WorldDataNotify.WorldPropMapEntry
	(*PropValue)(nil),             // 4: proto.PropValue
}
var file_WorldDataNotify_proto_depIdxs = []int32{
	3, // 0: proto.WorldDataNotify.world_prop_map:type_name -> proto.WorldDataNotify.WorldPropMapEntry
	4, // 1: proto.WorldDataNotify.WorldPropMapEntry.value:type_name -> proto.PropValue
