...
const (
	...
	TakeCompoundOutputRsp_CMD_ID           TakeCompoundOutputRsp_CmdId = 136
...
func (TakeCompoundOutputRsp_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_TakeCompoundOutputRsp_proto_enumTypes[0].Descriptor()
}

func (TakeCompoundOutputRsp_CmdId) Type() protoreflect.EnumType {
	return &file_TakeCompoundOutputRsp_proto_enumTypes[0]
}
...
func (TakeCompoundOutputRsp_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_TakeCompoundOutputRsp_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *TakeCompoundOutputRsp) GetRetcode() uint32 {
	if x != nil {
		return x.Retcode
	}
	return 0
...
var file_TakeCompoundOutputRsp_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x6d, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa9,
	0x01, 0x0a, 0x15, 0x54, 0x61, 0x6b, 0x65, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x75, 0x6e, 0x64, 0x4f,
	0x75, 0x74, 0x70, 0x75, 0x74, 0x52, 0x73, 0x70, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x65, 0x74, 0x63,
	0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f,
	0x64, 0x65, 0x12, 0x27, 0x0a, 0x09, 0x69, 0x74, 0x65, 0x6d, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18,
	...
	0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0x88, 0x01, 0x12, 0x13, 0x0a, 0x0f, 0x45,
...
var file_TakeCompoundOutputRsp_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_TakeCompoundOutputRsp_proto_goTypes = []interface{}{
	(TakeCompoundOutputRsp_CmdId)(0), // 0: TakeCompoundOutputRsp.CmdId
	(*TakeCompoundOutputRsp)(nil),    // 1: TakeCompoundOutputRsp
	(*ItemParam)(nil),                // 2: ItemParam
}
var file_TakeCompoundOutputRsp_proto_depIdxs = []int32{
	2, // 0: TakeCompoundOutputRsp.item_list:type_name -> ItemParam
...
func file_TakeCompoundOutputRsp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_TakeCompoundOutputRsp_proto_enumTypes,
