...
type BattlePassRewardTakeOption struct {
	...
	Tag       *BattlePassRewardTag `protobuf:"bytes,1,opt,name=tag,proto3" json:"tag,omitempty"`
	OptionIdx uint32               `protobuf:"varint,2,opt,name=option_idx,json=optionIdx,proto3" json:"option_idx,omitempty"`
}
...
var file_BattlePassRewardTakeOption_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x42, 0x61, 0x74, 0x74, 0x6c,
	...
	0x78, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x49,
