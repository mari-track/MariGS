...
const (
	...
	EvtAvatarSitDownNotify_CMD_ID           EvtAvatarSitDownNotify_CmdId = 341
...
func (EvtAvatarSitDownNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_EvtAvatarSitDownNotify_proto_enumTypes[0].Descriptor()
}

func (EvtAvatarSitDownNotify_CmdId) Type() protoreflect.EnumType {
	return &file_EvtAvatarSitDownNotify_proto_enumTypes[0]
}
...
func (EvtAvatarSitDownNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_EvtAvatarSitDownNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_EvtAvatarSitDownNotify_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xc4, 0x01, 0x0a, 0x16, 0x45, 0x76, 0x74, 0x41, 0x76, 0x61, 0x74, 0x61,
	0x72, 0x53, 0x69, 0x74, 0x44, 0x6f, 0x77, 0x6e, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x1b,
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x56, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x52, 0x08, 0x70, 0x6f,
	0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x62, 0x0a, 0x05, 0x43, 0x6d, 0x64, 0x49, 0x64, 0x12,
	0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44,
	0x5f, 0x49, 0x44, 0x10, 0xd5, 0x02, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f, 0x43,
...
var file_EvtAvatarSitDownNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_EvtAvatarSitDownNotify_proto_goTypes = []interface{}{
	(EvtAvatarSitDownNotify_CmdId)(0), // 0: proto.EvtAvatarSitDownNotify.CmdId
	(*EvtAvatarSitDownNotify)(nil),    // 1: proto.EvtAvatarSitDownNotify
	(*Vector)(nil),                    // 2: proto.Vector
}
var file_EvtAvatarSitDownNotify_proto_depIdxs = []int32{
	2, // 0: proto.EvtAvatarSitDownNotify.position:type_name -> proto.Vector
...
func file_EvtAvatarSitDownNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_EvtAvatarSitDownNotify_proto_enumTypes,
