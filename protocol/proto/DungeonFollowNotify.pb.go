...
const (
	...
	DungeonFollowNotify_CMD_ID           DungeonFollowNotify_CmdId = 921
...
func (DungeonFollowNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_DungeonFollowNotify_proto_enumTypes[0].Descriptor()
}

func (DungeonFollowNotify_CmdId) Type() protoreflect.EnumType {
	return &file_DungeonFollowNotify_proto_enumTypes[0]
}
...
func (DungeonFollowNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_DungeonFollowNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_DungeonFollowNotify_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x83, 0x01, 0x0a, 0x13, 0x44, 0x75, 0x6e, 0x67, 0x65, 0x6f, 0x6e, 0x46, 0x6f,
	0x6c, 0x6c, 0x6f, 0x77, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x61,
	...
	0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0x99, 0x07, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45,
...
var file_DungeonFollowNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_DungeonFollowNotify_proto_goTypes = []interface{}{
	(DungeonFollowNotify_CmdId)(0), // 0: proto.DungeonFollowNotify.CmdId
	(*DungeonFollowNotify)(nil),    // 1: proto.DungeonFollowNotify
}
...
func file_DungeonFollowNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_DungeonFollowNotify_proto_enumTypes,
