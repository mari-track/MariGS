...
type ActivityCondStateChangeNotify_CmdId int32

const (
	ActivityCondStateChangeNotify_NONE             ActivityCondStateChangeNotify_CmdId = 0
	ActivityCondStateChangeNotify_CMD_ID           ActivityCondStateChangeNotify_CmdId = 2035
	ActivityCondStateChangeNotify_ENET_CHANNEL_ID  ActivityCondStateChangeNotify_CmdId = 0
	ActivityCondStateChangeNotify_ENET_IS_RELIABLE ActivityCondStateChangeNotify_CmdId = 1
)

// Enum value maps for ActivityCondStateChangeNotify_CmdId.
var (
	ActivityCondStateChangeNotify_CmdId_name = map[int32]string{
		0:    "NONE",
		2035: "CMD_ID",
		// Duplicate value: 0: "ENET_CHANNEL_ID",
		1: "ENET_IS_RELIABLE",
	}
	ActivityCondStateChangeNotify_CmdId_value = map[string]int32{
		"NONE":             0,
		"CMD_ID":           2035,
		"ENET_CHANNEL_ID":  0,
		"ENET_IS_RELIABLE": 1,
...
func (x ActivityCondStateChangeNotify_CmdId) Enum() *ActivityCondStateChangeNotify_CmdId {
	p := new(ActivityCondStateChangeNotify_CmdId)
	*p = x
	return p
}

func (x ActivityCondStateChangeNotify_CmdId) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ActivityCondStateChangeNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_ActivityCondStateChangeNotify_proto_enumTypes[0].Descriptor()
}

func (ActivityCondStateChangeNotify_CmdId) Type() protoreflect.EnumType {
	return &file_ActivityCondStateChangeNotify_proto_enumTypes[0]
}

func (x ActivityCondStateChangeNotify_CmdId) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ActivityCondStateChangeNotify_CmdId.Descriptor instead.
func (ActivityCondStateChangeNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_ActivityCondStateChangeNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
type ActivityCondStateChangeNotify struct {
	...
	MeetCondList   []uint32 `protobuf:"varint,3,rep,packed,name=meet_cond_list,json=meetCondList,proto3" json:"meet_cond_list,omitempty"`
	ExpireCondList []uint32 `protobuf:"varint,4,rep,packed,name=expire_cond_list,json=expireCondList,proto3" json:"expire_cond_list,omitempty"`
}
...
var file_ActivityCondStateChangeNotify_proto_rawDesc = []byte{
	...
	,
...
var file_ActivityCondStateChangeNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_ActivityCondStateChangeNotify_proto_goTypes = []interface{}{
	(ActivityCondStateChangeNotify_CmdId)(0), // 0: ActivityCondStateChangeNotify.CmdId
	(*ActivityCondStateChangeNotify)(nil),    // 1: ActivityCondStateChangeNotify
}
...
func file_ActivityCondStateChangeNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_ActivityCondStateChangeNotify_proto_enumTypes,
