...
const (
	...
	RemoveBlacklistReq_CMD_ID           RemoveBlacklistReq_CmdId = 4029
...
func (RemoveBlacklistReq_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_RemoveBlacklistReq_proto_enumTypes[0].Descriptor()
}

func (RemoveBlacklistReq_CmdId) Type() protoreflect.EnumType {
	return &file_RemoveBlacklistReq_proto_enumTypes[0]
}
...
func (RemoveBlacklistReq_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_RemoveBlacklistReq_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_RemoveBlacklistReq_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x97, 0x01, 0x0a, 0x12, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x42, 0x6c, 0x61, 0x63,
	0x6b, 0x6c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x61, 0x72, 0x67,
	...
	0x44, 0x5f, 0x49, 0x44, 0x10, 0xbd, 0x1f, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f,
...
var file_RemoveBlacklistReq_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_RemoveBlacklistReq_proto_goTypes = []interface{}{
	(RemoveBlacklistReq_CmdId)(0), // 0: proto.RemoveBlacklistReq.CmdId
	(*RemoveBlacklistReq)(nil),    // 1: proto.RemoveBlacklistReq
}
...
func file_RemoveBlacklistReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_RemoveBlacklistReq_proto_enumTypes,
