...
const (
	...
	EntityPropNotify_CMD_ID           EntityPropNotify_CmdId = 1201
...
var file_EntityPropNotify_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x81, 0x02, 0x0a, 0x10, 0x45, 0x6e,
	...
	0x72, 0x6f, 0x70, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e,
	...
	0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xb1, 0x09, 0x12, 0x13,
...
var file_EntityPropNotify_proto_goTypes = []interface{}{
	(EntityPropNotify_CmdId)(0), // 0: EntityPropNotify.CmdId
	(*EntityPropNotify)(nil),    // 1: EntityPropNotify
	nil,                         // 2: EntityPropNotify.PropMapEntry
	(*PropValue)(nil),           // 3: PropValue
}
var file_EntityPropNotify_proto_depIdxs = []int32{
	2, // 0: EntityPropNotify.prop_map:type_name -> EntityPropNotify.PropMapEntry
	3, // 1: EntityPropNotify.PropMapEntry.value:type_name -> PropValue
