...
const (
	...
	GetCompoundDataReq_CMD_ID           GetCompoundDataReq_CmdId = 138
...
func (GetCompoundDataReq_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_GetCompoundDataReq_proto_enumTypes[0].Descriptor()
}

func (GetCompoundDataReq_CmdId) Type() protoreflect.EnumType {
	return &file_GetCompoundDataReq_proto_enumTypes[0]
}
...
func (GetCompoundDataReq_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_GetCompoundDataReq_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_GetCompoundDataReq_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x78, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x75, 0x6e, 0x64,
	...
	0x44, 0x5f, 0x49, 0x44, 0x10, 0x8a, 0x01, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f,
...
var file_GetCompoundDataReq_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_GetCompoundDataReq_proto_goTypes = []interface{}{
	(GetCompoundDataReq_CmdId)(0), // 0: proto.GetCompoundDataReq.CmdId
	(*GetCompoundDataReq)(nil),    // 1: proto.GetCompoundDataReq
}
...
func file_GetCompoundDataReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_GetCompoundDataReq_proto_enumTypes,
