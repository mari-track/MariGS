...
const (
	...
	WorldPlayerRTTNotify_CMD_ID           WorldPlayerRTTNotify_CmdId = 21
...
func (WorldPlayerRTTNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_WorldPlayerRTTNotify_proto_enumTypes[0].Descriptor()
}

func (WorldPlayerRTTNotify_CmdId) Type() protoreflect.EnumType {
	return &file_WorldPlayerRTTNotify_proto_enumTypes[0]
}
...
func (WorldPlayerRTTNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_WorldPlayerRTTNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_WorldPlayerRTTNotify_proto_rawDesc = []byte{
	...
	0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa2, 0x01, 0x0a, 0x14, 0x57, 0x6f, 0x72,
	0x6c, 0x64, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x52, 0x54, 0x54, 0x4e, 0x6f, 0x74, 0x69, 0x66,
	0x79, 0x12, 0x3c, 0x0a, 0x0f, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x5f, 0x72, 0x74, 0x74, 0x5f,
	0x6c, 0x69, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2e, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x52, 0x54, 0x54, 0x49, 0x6e, 0x66, 0x6f,
	0x52, 0x0d, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x52, 0x74, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x22,
...
var file_WorldPlayerRTTNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_WorldPlayerRTTNotify_proto_goTypes = []interface{}{
	(WorldPlayerRTTNotify_CmdId)(0), // 0: proto.WorldPlayerRTTNotify.CmdId
	(*WorldPlayerRTTNotify)(nil),    // 1: proto.WorldPlayerRTTNotify
	(*PlayerRTTInfo)(nil),           // 2: proto.PlayerRTTInfo
}
var file_WorldPlayerRTTNotify_proto_depIdxs = []int32{
	2, // 0: proto.WorldPlayerRTTNotify.player_rtt_list:type_name -> proto.PlayerRTTInfo
...
func file_WorldPlayerRTTNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_WorldPlayerRTTNotify_proto_enumTypes,
