...
const (
	...
	BattlePassBuySuccNotify_CMD_ID           BattlePassBuySuccNotify_CmdId = 2615
...
func (BattlePassBuySuccNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_BattlePassBuySuccNotify_proto_enumTypes[0].Descriptor()
}

func (BattlePassBuySuccNotify_CmdId) Type() protoreflect.EnumType {
	return &file_BattlePassBuySuccNotify_proto_enumTypes[0]
}
...
func (BattlePassBuySuccNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_BattlePassBuySuccNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
type BattlePassBuySuccNotify struct {
	...
	ProductPlayType uint32       `protobuf:"varint,2,opt,name=product_play_type,json=productPlayType,proto3" json:"product_play_type,omitempty"`
	ItemList        []*ItemParam `protobuf:"bytes,3,rep,name=item_list,json=itemList,proto3" json:"item_list,omitempty"`
	AddPoint        uint32       `protobuf:"varint,4,opt,name=add_point,json=addPoint,proto3" json:"add_point,omitempty"`
}
...
var file_BattlePassBuySuccNotify_proto_rawDesc = []byte{
	...
	0x22, 0xfb, 0x01, 0x0a, 0x17, 0x42, 0x61, 0x74, 0x74, 0x6c, 0x65, 0x50, 0x61, 0x73, 0x73, 0x42,
	...
	0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63,
	0x74, 0x50, 0x6c, 0x61, 0x79, 0x54, 0x79, 0x70, 0x65, 0x12, 0x27, 0x0a, 0x09, 0x69, 0x74, 0x65,
	...
	0x73, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x61, 0x64, 0x64, 0x5f, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x61, 0x64, 0x64, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x22,
	0x4d, 0x0a, 0x05, 0x43, 0x6d, 0x64, 0x49, 0x64, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45,
	0x10, 0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xb7, 0x14, 0x12,
...
var file_BattlePassBuySuccNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_BattlePassBuySuccNotify_proto_goTypes = []interface{}{
	(BattlePassBuySuccNotify_CmdId)(0), // 0: BattlePassBuySuccNotify.CmdId
	(*BattlePassBuySuccNotify)(nil),    // 1: BattlePassBuySuccNotify
	(*ItemParam)(nil),                  // 2: ItemParam
}
var file_BattlePassBuySuccNotify_proto_depIdxs = []int32{
	2, // 0: BattlePassBuySuccNotify.item_list:type_name -> ItemParam
...
func file_BattlePassBuySuccNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_BattlePassBuySuccNotify_proto_enumTypes,
