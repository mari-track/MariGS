...
const (
	...
	QuestTransmitReq_CMD_ID           QuestTransmitReq_CmdId = 433
...
func (QuestTransmitReq_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_QuestTransmitReq_proto_enumTypes[0].Descriptor()
}

func (QuestTransmitReq_CmdId) Type() protoreflect.EnumType {
	return &file_QuestTransmitReq_proto_enumTypes[0]
}
...
func (QuestTransmitReq_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_QuestTransmitReq_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_QuestTransmitReq_proto_rawDesc = []byte{
	...
	0x65, 0x71, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xac, 0x01, 0x0a, 0x10, 0x51, 0x75, 0x65,
	0x73, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x6d, 0x69, 0x74, 0x52, 0x65, 0x71, 0x12, 0x19, 0x0a,
	0x08, 0x71, 0x75, 0x65, 0x73, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x07, 0x71, 0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x70, 0x6f, 0x69, 0x6e,
	0x74, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x70, 0x6f, 0x69, 0x6e,
	...
	0x10, 0xb1, 0x03, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f, 0x43, 0x48, 0x41, 0x4e,
...
var file_QuestTransmitReq_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_QuestTransmitReq_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_QuestTransmitReq_proto_goTypes = []interface{}{
	(QuestTransmitReq_CmdId)(0), // 0: QuestTransmitReq.CmdId
	(*QuestTransmitReq)(nil),    // 1: QuestTransmitReq
}
...
func file_QuestTransmitReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_QuestTransmitReq_proto_enumTypes,
