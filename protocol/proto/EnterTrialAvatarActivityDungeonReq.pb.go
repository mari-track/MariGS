...
type EnterTrialAvatarActivityDungeonReq_CmdId int32

const (
	EnterTrialAvatarActivityDungeonReq_NONE             EnterTrialAvatarActivityDungeonReq_CmdId = 0
	EnterTrialAvatarActivityDungeonReq_CMD_ID           EnterTrialAvatarActivityDungeonReq_CmdId = 2041
	EnterTrialAvatarActivityDungeonReq_ENET_CHANNEL_ID  EnterTrialAvatarActivityDungeonReq_CmdId = 0
	EnterTrialAvatarActivityDungeonReq_ENET_IS_RELIABLE EnterTrialAvatarActivityDungeonReq_CmdId = 1
	EnterTrialAvatarActivityDungeonReq_IS_ALLOW_CLIENT  EnterTrialAvatarActivityDungeonReq_CmdId = 1
)

// Enum value maps for EnterTrialAvatarActivityDungeonReq_CmdId.
var (
	EnterTrialAvatarActivityDungeonReq_CmdId_name = map[int32]string{
		0:    "NONE",
		2041: "CMD_ID",
	...
	EnterTrialAvatarActivityDungeonReq_CmdId_value = map[string]int32{
		"NONE":             0,
		"CMD_ID":           2041,
		"ENET_CHANNEL_ID":  0,
		"ENET_IS_RELIABLE": 1,
...
func (x EnterTrialAvatarActivityDungeonReq_CmdId) Enum() *EnterTrialAvatarActivityDungeonReq_CmdId {
	p := new(EnterTrialAvatarActivityDungeonReq_CmdId)
	*p = x
	return p
}

func (x EnterTrialAvatarActivityDungeonReq_CmdId) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (EnterTrialAvatarActivityDungeonReq_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_EnterTrialAvatarActivityDungeonReq_proto_enumTypes[0].Descriptor()
}

func (EnterTrialAvatarActivityDungeonReq_CmdId) Type() protoreflect.EnumType {
	return &file_EnterTrialAvatarActivityDungeonReq_proto_enumTypes[0]
}

func (x EnterTrialAvatarActivityDungeonReq_CmdId) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use EnterTrialAvatarActivityDungeonReq_CmdId.Descriptor instead.
func (EnterTrialAvatarActivityDungeonReq_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_EnterTrialAvatarActivityDungeonReq_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_EnterTrialAvatarActivityDungeonReq_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x82, 0x02, 0x0a, 0x22, 0x45, 0x6e, 0x74, 0x65, 0x72, 0x54, 0x72, 0x69, 0x61, 0x6c,
	...
	0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x49, 0x64, 0x12, 0x31, 0x0a, 0x15, 0x74, 0x72, 0x69,
	0x61, 0x6c, 0x5f, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x5f,
	0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x12, 0x74, 0x72, 0x69, 0x61, 0x6c, 0x41,
	0x76, 0x61, 0x74, 0x61, 0x72, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x49, 0x64, 0x12, 0x24, 0x0a, 0x0e,
	0x65, 0x6e, 0x74, 0x65, 0x72, 0x5f, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x0c, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x50, 0x6f, 0x69, 0x6e, 0x74,
	...
	0xf9, 0x0f, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f, 0x43, 0x48, 0x41, 0x4e, 0x4e,
...
var file_EnterTrialAvatarActivityDungeonReq_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_EnterTrialAvatarActivityDungeonReq_proto_goTypes = []interface{}{
	(EnterTrialAvatarActivityDungeonReq_CmdId)(0), // 0: proto.EnterTrialAvatarActivityDungeonReq.CmdId
	(*EnterTrialAvatarActivityDungeonReq)(nil),    // 1: proto.EnterTrialAvatarActivityDungeonReq
}
...
func file_EnterTrialAvatarActivityDungeonReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_EnterTrialAvatarActivityDungeonReq_proto_enumTypes,
