...
const (
	...
	AvatarPropNotify_CMD_ID           AvatarPropNotify_CmdId = 1211
...
type AvatarPropNotify struct {
	...
	PropMap    map[uint32]int64 `protobuf:"bytes,2,rep,name=prop_map,json=propMap,proto3" json:"prop_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
var file_AvatarPropNotify_proto_rawDesc = []byte{
	...
	0x66, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf9, 0x01, 0x0a, 0x10, 0x41, 0x76, 0x61,
	...
	0x49, 0x44, 0x10, 0xbb, 0x09, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f, 0x43, 0x48,
...
var file_AvatarPropNotify_proto_goTypes = []interface{}{
	(AvatarPropNotify_CmdId)(0), // 0: AvatarPropNotify.CmdId
	(*AvatarPropNotify)(nil),    // 1: AvatarPropNotify
	nil,                         // 2: AvatarPropNotify.PropMapEntry
}
var file_AvatarPropNotify_proto_depIdxs = []int32{
	2, // 0: AvatarPropNotify.prop_map:type_name -> AvatarPropNotify.PropMapEntry
