...
type EntityRendererChangedInfo struct {
	...
	ChangedRenderers map[string]int32 `protobuf:"bytes,1,rep,name=changed_renderers,json=changedRenderers,proto3" json:"changed_renderers,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	VisibilityCount  int32            `protobuf:"varint,2,opt,name=visibility_count,json=visibilityCount,proto3" json:"visibility_count,omitempty"`
}
...
func (x *EntityRendererChangedInfo) GetChangedRenderers() map[string]int32 {
	if x != nil {
...
func (x *EntityRendererChangedInfo) GetVisibilityCount() int32 {
	if x != nil {
...
var file_EntityRendererChangedInfo_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf0, 0x01, 0x0a, 0x19, 0x45, 0x6e, 0x74,
	...
	0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0f, 0x76, 0x69, 0x73, 0x69, 0x62, 0x69, 0x6c, 0x69, 0x74,
	0x79, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x1a, 0x43, 0x0a, 0x15, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65,
