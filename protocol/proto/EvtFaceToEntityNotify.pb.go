...
const (
	...
	EvtFaceToEntityNotify_CMD_ID           EvtFaceToEntityNotify_CmdId = 307
...
func (EvtFaceToEntityNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_EvtFaceToEntityNotify_proto_enumTypes[0].Descriptor()
}

func (EvtFaceToEntityNotify_CmdId) Type() protoreflect.EnumType {
	return &file_EvtFaceToEntityNotify_proto_enumTypes[0]
}
...
func (EvtFaceToEntityNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_EvtFaceToEntityNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
type EvtFaceToEntityNotify struct {
	...
	FaceEntityId uint32      `protobuf:"varint,3,opt,name=face_entity_id,json=faceEntityId,proto3" json:"face_entity_id,omitempty"`
}
...
var file_EvtFaceToEntityNotify_proto_rawDesc = []byte{
	...
	0x22, 0xef, 0x01, 0x0a, 0x15, 0x45, 0x76, 0x74, 0x46, 0x61, 0x63, 0x65, 0x54, 0x6f, 0x45, 0x6e,
	0x74, 0x69, 0x74, 0x79, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x2f, 0x0a, 0x0c, 0x66, 0x6f,
	...
	0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x49, 0x64, 0x12, 0x24, 0x0a, 0x0e, 0x66, 0x61, 0x63, 0x65,
	0x5f, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x0c, 0x66, 0x61, 0x63, 0x65, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x49, 0x64, 0x22, 0x62,
	0x0a, 0x05, 0x43, 0x6d, 0x64, 0x49, 0x64, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10,
	0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xb3, 0x02, 0x12, 0x13,
...
var file_EvtFaceToEntityNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_EvtFaceToEntityNotify_proto_goTypes = []interface{}{
	(EvtFaceToEntityNotify_CmdId)(0), // 0: EvtFaceToEntityNotify.CmdId
	(*EvtFaceToEntityNotify)(nil),    // 1: EvtFaceToEntityNotify
	(ForwardType)(0),                 // 2: ForwardType
}
var file_EvtFaceToEntityNotify_proto_depIdxs = []int32{
	2, // 0: EvtFaceToEntityNotify.forward_type:type_name -> ForwardType
...
func file_EvtFaceToEntityNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_EvtFaceToEntityNotify_proto_enumTypes,
