...
const (
	...
	EvtBeingHitNotify_CMD_ID           EvtBeingHitNotify_CmdId = 301
...
var file_EvtBeingHitNotify_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xe0, 0x01, 0x0a, 0x11, 0x45, 0x76, 0x74, 0x42, 0x65, 0x69, 0x6e, 0x67,
	...
	0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x54, 0x79, 0x70, 0x65, 0x12, 0x36, 0x0a, 0x0e, 0x62, 0x65,
	0x69, 0x6e, 0x67, 0x5f, 0x68, 0x69, 0x74, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x10, 0x2e, 0x45, 0x76, 0x74, 0x42, 0x65, 0x69, 0x6e, 0x67, 0x48, 0x69, 0x74,
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x0c, 0x62, 0x65, 0x69, 0x6e, 0x67, 0x48, 0x69, 0x74, 0x49, 0x6e,
	...
	0xad, 0x02, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f, 0x43, 0x48, 0x41, 0x4e, 0x4e,
...
var file_EvtBeingHitNotify_proto_goTypes = []interface{}{
	(EvtBeingHitNotify_CmdId)(0), // 0: EvtBeingHitNotify.CmdId
	(*EvtBeingHitNotify)(nil),    // 1: EvtBeingHitNotify
	(ForwardType)(0),             // 2: ForwardType
	(*EvtBeingHitInfo)(nil),      // 3: EvtBeingHitInfo
}
var file_EvtBeingHitNotify_proto_depIdxs = []int32{
	2, // 0: EvtBeingHitNotify.forward_type:type_name -> ForwardType
	3, // 1: EvtBeingHitNotify.being_hit_info:type_name -> EvtBeingHitInfo
