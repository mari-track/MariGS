...
const (
	...
	GetAuthkeyReq_CMD_ID           GetAuthkeyReq_CmdId = 1408
...
func (GetAuthkeyReq_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_GetAuthkeyReq_proto_enumTypes[0].Descriptor()
}

func (GetAuthkeyReq_CmdId) Type() protoreflect.EnumType {
	return &file_GetAuthkeyReq_proto_enumTypes[0]
}
...
func (GetAuthkeyReq_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_GetAuthkeyReq_proto_rawDescGZIP(), []int{0, 0}
}
...
type GetAuthkeyReq struct {
	...
	AuthAppid  string `protobuf:"bytes,1,opt,name=auth_appid,json=authAppid,proto3" json:"auth_appid,omitempty"`
	SignType   uint32 `protobuf:"varint,2,opt,name=sign_type,json=signType,proto3" json:"sign_type,omitempty"`
...
var file_GetAuthkeyReq_proto_rawDesc = []byte{
	...
	,
...
var file_GetAuthkeyReq_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_GetAuthkeyReq_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_GetAuthkeyReq_proto_goTypes = []interface{}{
	(GetAuthkeyReq_CmdId)(0), // 0: proto.GetAuthkeyReq.CmdId
	(*GetAuthkeyReq)(nil),    // 1: proto.GetAuthkeyReq
}
...
func file_GetAuthkeyReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_GetAuthkeyReq_proto_enumTypes,
