...
type AbilityArgument_IntArg struct {
	IntArg uint32 `protobuf:"varint,1,opt,name=int_arg,json=intArg,proto3,oneof"`
}

type AbilityArgument_FloatArg struct {
	FloatArg float32 `protobuf:"fixed32,2,opt,name=float_arg,json=floatArg,proto3,oneof"`
}

type AbilityArgument_StrArg struct {
	StrArg string `protobuf:"bytes,3,opt,name=str_arg,json=strArg,proto3,oneof"`
}
...
var file_AbilityArgument_proto_rawDesc = []byte{
	...
	0x74, 0x12, 0x19, 0x0a, 0x07, 0x69, 0x6e, 0x74, 0x5f, 0x61, 0x72, 0x67, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0d, 0x48, 0x00, 0x52, 0x06, 0x69, 0x6e, 0x74, 0x41, 0x72, 0x67, 0x12, 0x1d, 0x0a, 0x09,
	0x66, 0x6c, 0x6f, 0x61, 0x74, 0x5f, 0x61, 0x72, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x02, 0x48,
	0x00, 0x52, 0x08, 0x66, 0x6c, 0x6f, 0x61, 0x74, 0x41, 0x72, 0x67, 0x12, 0x19, 0x0a, 0x07, 0x73,
	0x74, 0x72, 0x5f, 0x61, 0x72, 0x67, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x06,
