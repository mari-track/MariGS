...
const (
	...
	EvtFaceToDirNotify_CMD_ID           EvtFaceToDirNotify_CmdId = 308
...
func (EvtFaceToDirNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_EvtFaceToDirNotify_proto_enumTypes[0].Descriptor()
}

func (EvtFaceToDirNotify_CmdId) Type() protoreflect.EnumType {
	return &file_EvtFaceToDirNotify_proto_enumTypes[0]
}
...
func (EvtFaceToDirNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_EvtFaceToDirNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_EvtFaceToDirNotify_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x16, 0x45, 0x76, 0x74, 0x46, 0x61, 0x63, 0x65, 0x54, 0x6f, 0x44,
	0x69, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf8, 0x01, 0x0a,
	...
	0x10, 0xb4, 0x02, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f, 0x43, 0x48, 0x41, 0x4e,
...
var file_EvtFaceToDirNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_EvtFaceToDirNotify_proto_goTypes = []interface{}{
	(EvtFaceToDirNotify_CmdId)(0), // 0: proto.EvtFaceToDirNotify.CmdId
	(*EvtFaceToDirNotify)(nil),    // 1: proto.EvtFaceToDirNotify
	(ForwardType)(0),              // 2: proto.ForwardType
	(*EvtFaceToDirInfo)(nil),      // 3: proto.EvtFaceToDirInfo
}
var file_EvtFaceToDirNotify_proto_depIdxs = []int32{
	2, // 0: proto.EvtFaceToDirNotify.forward_type:type_name -> proto.ForwardType
	3, // 1: proto.EvtFaceToDirNotify.evt_face_to_dir_info:type_name -> proto.EvtFaceToDirInfo
...
func file_EvtFaceToDirNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_EvtFaceToDirNotify_proto_enumTypes,
