...
var file_EvtFaceToDirNotify_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xec, 0x01, 0x0a, 0x12, 0x45, 0x76, 0x74, 0x46, 0x61, 0x63,
	...
	0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x45, 0x76,
	...
	0x45, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xb4, 0x02,
...
var file_EvtFaceToDirNotify_proto_goTypes = []interface{}{
	(EvtFaceToDirNotify_CmdId)(0), // 0: EvtFaceToDirNotify.CmdId
	(*EvtFaceToDirNotify)(nil),    // 1: EvtFaceToDirNotify
	(ForwardType)(0),              // 2: ForwardType
	(*EvtFaceToDirInfo)(nil),      // 3: EvtFaceToDirInfo
}
var file_EvtFaceToDirNotify_proto_depIdxs = []int32{
	2, // 0: EvtFaceToDirNotify.forward_type:type_name -> ForwardType
	3, // 1: EvtFaceToDirNotify.evt_face_to_dir_info:type_name -> EvtFaceToDirInfo
