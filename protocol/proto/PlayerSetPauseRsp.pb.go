...
const (
	...
	PlayerSetPauseRsp_CMD_ID           PlayerSetPauseRsp_CmdId = 142
...
func (PlayerSetPauseRsp_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_PlayerSetPauseRsp_proto_enumTypes[0].Descriptor()
}

func (PlayerSetPauseRsp_CmdId) Type() protoreflect.EnumType {
	return &file_PlayerSetPauseRsp_proto_enumTypes[0]
}
...
func (PlayerSetPauseRsp_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_PlayerSetPauseRsp_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *PlayerSetPauseRsp) GetRetcode() uint32 {
	if x != nil {
		return x.Retcode
	}
	return 0
...
var file_PlayerSetPauseRsp_proto_rawDesc = []byte{
	...
	0x22, 0x7c, 0x0a, 0x11, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x53, 0x65, 0x74, 0x50, 0x61, 0x75,
	0x73, 0x65, 0x52, 0x73, 0x70, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x22,
	0x4d, 0x0a, 0x05, 0x43, 0x6d, 0x64, 0x49, 0x64, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45,
	0x10, 0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0x8e, 0x01, 0x12,
...
var file_PlayerSetPauseRsp_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_PlayerSetPauseRsp_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_PlayerSetPauseRsp_proto_goTypes = []interface{}{
	(PlayerSetPauseRsp_CmdId)(0), // 0: proto.PlayerSetPauseRsp.CmdId
	(*PlayerSetPauseRsp)(nil),    // 1: proto.PlayerSetPauseRsp
}
...
func file_PlayerSetPauseRsp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_PlayerSetPauseRsp_proto_enumTypes,
