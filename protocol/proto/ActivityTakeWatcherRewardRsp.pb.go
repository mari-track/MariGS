...
type ActivityTakeWatcherRewardRsp_CmdId int32

const (
	ActivityTakeWatcherRewardRsp_NONE             ActivityTakeWatcherRewardRsp_CmdId = 0
	ActivityTakeWatcherRewardRsp_CMD_ID           ActivityTakeWatcherRewardRsp_CmdId = 2009
	ActivityTakeWatcherRewardRsp_ENET_CHANNEL_ID  ActivityTakeWatcherRewardRsp_CmdId = 0
	ActivityTakeWatcherRewardRsp_ENET_IS_RELIABLE ActivityTakeWatcherRewardRsp_CmdId = 1
)

// Enum value maps for ActivityTakeWatcherRewardRsp_CmdId.
var (
	ActivityTakeWatcherRewardRsp_CmdId_name = map[int32]string{
		0:    "NONE",
		2009: "CMD_ID",
		// Duplicate value: 0: "ENET_CHANNEL_ID",
		1: "ENET_IS_RELIABLE",
	}
	ActivityTakeWatcherRewardRsp_CmdId_value = map[string]int32{
		"NONE":             0,
		"CMD_ID":           2009,
		"ENET_CHANNEL_ID":  0,
		"ENET_IS_RELIABLE": 1,
...
func (x ActivityTakeWatcherRewardRsp_CmdId) Enum() *ActivityTakeWatcherRewardRsp_CmdId {
	p := new(ActivityTakeWatcherRewardRsp_CmdId)
	*p = x
	return p
}

func (x ActivityTakeWatcherRewardRsp_CmdId) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ActivityTakeWatcherRewardRsp_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_ActivityTakeWatcherRewardRsp_proto_enumTypes[0].Descriptor()
}

func (ActivityTakeWatcherRewardRsp_CmdId) Type() protoreflect.EnumType {
	return &file_ActivityTakeWatcherRewardRsp_proto_enumTypes[0]
}

func (x ActivityTakeWatcherRewardRsp_CmdId) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ActivityTakeWatcherRewardRsp_CmdId.Descriptor instead.
func (ActivityTakeWatcherRewardRsp_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_ActivityTakeWatcherRewardRsp_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_ActivityTakeWatcherRewardRsp_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc7, 0x01, 0x0a, 0x1c,
	0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x54, 0x61, 0x6b, 0x65, 0x57, 0x61, 0x74, 0x63,
	0x68, 0x65, 0x72, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x52, 0x73, 0x70, 0x12, 0x18, 0x0a, 0x07,
	...
	0x69, 0x76, 0x69, 0x74, 0x79, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x77, 0x61, 0x74, 0x63, 0x68,
	0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x77, 0x61, 0x74,
	0x63, 0x68, 0x65, 0x72, 0x49, 0x64, 0x22, 0x4d, 0x0a, 0x05, 0x43, 0x6d, 0x64, 0x49, 0x64, 0x12,
	0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44,
	0x5f, 0x49, 0x44, 0x10, 0xd9, 0x0f, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f, 0x43,
...
var file_ActivityTakeWatcherRewardRsp_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_ActivityTakeWatcherRewardRsp_proto_goTypes = []interface{}{
	(ActivityTakeWatcherRewardRsp_CmdId)(0), // 0: proto.ActivityTakeWatcherRewardRsp.CmdId
	(*ActivityTakeWatcherRewardRsp)(nil),    // 1: proto.ActivityTakeWatcherRewardRsp
}
...
func file_ActivityTakeWatcherRewardRsp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_ActivityTakeWatcherRewardRsp_proto_enumTypes,
