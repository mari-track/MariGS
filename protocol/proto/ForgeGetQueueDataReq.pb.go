...
const (
	...
	ForgeGetQueueDataReq_CMD_ID           ForgeGetQueueDataReq_CmdId = 637
...
func (ForgeGetQueueDataReq_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_ForgeGetQueueDataReq_proto_enumTypes[0].Descriptor()
}

func (ForgeGetQueueDataReq_CmdId) Type() protoreflect.EnumType {
	return &file_ForgeGetQueueDataReq_proto_enumTypes[0]
}
...
func (ForgeGetQueueDataReq_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_ForgeGetQueueDataReq_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_ForgeGetQueueDataReq_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x7a, 0x0a, 0x14, 0x46, 0x6f, 0x72, 0x67, 0x65, 0x47, 0x65, 0x74, 0x51,
	0x75, 0x65, 0x75, 0x65, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x71, 0x22, 0x62, 0x0a, 0x05, 0x43,
	0x6d, 0x64, 0x49, 0x64, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0b,
	0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xfd, 0x04, 0x12, 0x13, 0x0a, 0x0f, 0x45,
...
var file_ForgeGetQueueDataReq_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_ForgeGetQueueDataReq_proto_goTypes = []interface{}{
	(ForgeGetQueueDataReq_CmdId)(0), // 0: proto.ForgeGetQueueDataReq.CmdId
	(*ForgeGetQueueDataReq)(nil),    // 1: proto.ForgeGetQueueDataReq
}
...
func file_ForgeGetQueueDataReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_ForgeGetQueueDataReq_proto_enumTypes,
