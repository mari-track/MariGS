...
type ReceivedTrialAvatarActivityRewardRsp_CmdId int32

const (
	ReceivedTrialAvatarActivityRewardRsp_NONE             ReceivedTrialAvatarActivityRewardRsp_CmdId = 0
	ReceivedTrialAvatarActivityRewardRsp_CMD_ID           ReceivedTrialAvatarActivityRewardRsp_CmdId = 2044
	ReceivedTrialAvatarActivityRewardRsp_ENET_CHANNEL_ID  ReceivedTrialAvatarActivityRewardRsp_CmdId = 0
	ReceivedTrialAvatarActivityRewardRsp_ENET_IS_RELIABLE ReceivedTrialAvatarActivityRewardRsp_CmdId = 1
)

// Enum value maps for ReceivedTrialAvatarActivityRewardRsp_CmdId.
var (
	ReceivedTrialAvatarActivityRewardRsp_CmdId_name = map[int32]string{
		0:    "NONE",
		2044: "CMD_ID",
		// Duplicate value: 0: "ENET_CHANNEL_ID",
		1: "ENET_IS_RELIABLE",
	}
	ReceivedTrialAvatarActivityRewardRsp_CmdId_value = map[string]int32{
		"NONE":             0,
		"CMD_ID":           2044,
		"ENET_CHANNEL_ID":  0,
		"ENET_IS_RELIABLE": 1,
...
func (x ReceivedTrialAvatarActivityRewardRsp_CmdId) Enum() *ReceivedTrialAvatarActivityRewardRsp_CmdId {
	p := new(ReceivedTrialAvatarActivityRewardRsp_CmdId)
	*p = x
	return p
}

func (x ReceivedTrialAvatarActivityRewardRsp_CmdId) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ReceivedTrialAvatarActivityRewardRsp_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_ReceivedTrialAvatarActivityRewardRsp_proto_enumTypes[0].Descriptor()
}

func (ReceivedTrialAvatarActivityRewardRsp_CmdId) Type() protoreflect.EnumType {
	return &file_ReceivedTrialAvatarActivityRewardRsp_proto_enumTypes[0]
}

func (x ReceivedTrialAvatarActivityRewardRsp_CmdId) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ReceivedTrialAvatarActivityRewardRsp_CmdId.Descriptor instead.
func (ReceivedTrialAvatarActivityRewardRsp_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_ReceivedTrialAvatarActivityRewardRsp_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_ReceivedTrialAvatarActivityRewardRsp_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xe3, 0x01, 0x0a, 0x24, 0x52, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x64,
	0x54, 0x72, 0x69, 0x61, 0x6c, 0x41, 0x76, 0x61, 0x74, 0x61, 0x72, 0x41, 0x63, 0x74, 0x69, 0x76,
	0x69, 0x74, 0x79, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x52, 0x73, 0x70, 0x12, 0x18, 0x0a, 0x07,
	...
	0x69, 0x76, 0x69, 0x74, 0x79, 0x49, 0x64, 0x12, 0x31, 0x0a, 0x15, 0x74, 0x72, 0x69, 0x61, 0x6c,
	0x5f, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x5f, 0x69, 0x64,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x12, 0x74, 0x72, 0x69, 0x61, 0x6c, 0x41, 0x76, 0x61,
	0x74, 0x61, 0x72, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x49, 0x64, 0x22, 0x4d, 0x0a, 0x05, 0x43, 0x6d,
	0x64, 0x49, 0x64, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0b, 0x0a,
	0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xfc, 0x0f, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e,
...
var file_ReceivedTrialAvatarActivityRewardRsp_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_ReceivedTrialAvatarActivityRewardRsp_proto_goTypes = []interface{}{
	(ReceivedTrialAvatarActivityRewardRsp_CmdId)(0), // 0: proto.ReceivedTrialAvatarActivityRewardRsp.CmdId
	(*ReceivedTrialAvatarActivityRewardRsp)(nil),    // 1: proto.ReceivedTrialAvatarActivityRewardRsp
}
...
func file_ReceivedTrialAvatarActivityRewardRsp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_ReceivedTrialAvatarActivityRewardRsp_proto_enumTypes,
