...
type ActivityPlayOpenAnimNotify_CmdId int32

const (
	ActivityPlayOpenAnimNotify_NONE             ActivityPlayOpenAnimNotify_CmdId = 0
	ActivityPlayOpenAnimNotify_CMD_ID           ActivityPlayOpenAnimNotify_CmdId = 2005
	ActivityPlayOpenAnimNotify_ENET_CHANNEL_ID  ActivityPlayOpenAnimNotify_CmdId = 0
	ActivityPlayOpenAnimNotify_ENET_IS_RELIABLE ActivityPlayOpenAnimNotify_CmdId = 1
	ActivityPlayOpenAnimNotify_IS_ALLOW_CLIENT  ActivityPlayOpenAnimNotify_CmdId = 1
)

// Enum value maps for ActivityPlayOpenAnimNotify_CmdId.
var (
	ActivityPlayOpenAnimNotify_CmdId_name = map[int32]string{
		0:    "NONE",
		2005: "CMD_ID",
	...
	ActivityPlayOpenAnimNotify_CmdId_value = map[string]int32{
		"NONE":             0,
		"CMD_ID":           2005,
		"ENET_CHANNEL_ID":  0,
		"ENET_IS_RELIABLE": 1,
...
func (x ActivityPlayOpenAnimNotify_CmdId) Enum() *ActivityPlayOpenAnimNotify_CmdId {
	p := new(ActivityPlayOpenAnimNotify_CmdId)
	*p = x
	return p
}

func (x ActivityPlayOpenAnimNotify_CmdId) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ActivityPlayOpenAnimNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_ActivityPlayOpenAnimNotify_proto_enumTypes[0].Descriptor()
}

func (ActivityPlayOpenAnimNotify_CmdId) Type() protoreflect.EnumType {
	return &file_ActivityPlayOpenAnimNotify_proto_enumTypes[0]
}

func (x ActivityPlayOpenAnimNotify_CmdId) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ActivityPlayOpenAnimNotify_CmdId.Descriptor instead.
func (ActivityPlayOpenAnimNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_ActivityPlayOpenAnimNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_ActivityPlayOpenAnimNotify_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa1, 0x01, 0x0a, 0x1a, 0x41, 0x63,
	0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x50, 0x6c, 0x61, 0x79, 0x4f, 0x70, 0x65, 0x6e, 0x41, 0x6e,
	0x69, 0x6d, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x1f, 0x0a, 0x0b, 0x61, 0x63, 0x74, 0x69,
	0x76, 0x69, 0x74, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x61,
	0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x49, 0x64, 0x22, 0x62, 0x0a, 0x05, 0x43, 0x6d, 0x64,
	0x49, 0x64, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x06,
	0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xd5, 0x0f, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45,
...
var file_ActivityPlayOpenAnimNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_ActivityPlayOpenAnimNotify_proto_goTypes = []interface{}{
	(ActivityPlayOpenAnimNotify_CmdId)(0), // 0: proto.ActivityPlayOpenAnimNotify.CmdId
	(*ActivityPlayOpenAnimNotify)(nil),    // 1: proto.ActivityPlayOpenAnimNotify
}
...
func file_ActivityPlayOpenAnimNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_ActivityPlayOpenAnimNotify_proto_enumTypes,
