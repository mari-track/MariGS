...
type SalesmanDeliverItemReq_CmdId int32

const (
	SalesmanDeliverItemReq_NONE             SalesmanDeliverItemReq_CmdId = 0
	SalesmanDeliverItemReq_CMD_ID           SalesmanDeliverItemReq_CmdId = 2031
	SalesmanDeliverItemReq_ENET_CHANNEL_ID  SalesmanDeliverItemReq_CmdId = 0
	SalesmanDeliverItemReq_ENET_IS_RELIABLE SalesmanDeliverItemReq_CmdId = 1
	SalesmanDeliverItemReq_IS_ALLOW_CLIENT  SalesmanDeliverItemReq_CmdId = 1
)

// Enum value maps for SalesmanDeliverItemReq_CmdId.
var (
	SalesmanDeliverItemReq_CmdId_name = map[int32]string{
		0:    "NONE",
		2031: "CMD_ID",
	...
	SalesmanDeliverItemReq_CmdId_value = map[string]int32{
		"NONE":             0,
		"CMD_ID":           2031,
		"ENET_CHANNEL_ID":  0,
		"ENET_IS_RELIABLE": 1,
...
func (x SalesmanDeliverItemReq_CmdId) Enum() *SalesmanDeliverItemReq_CmdId {
	p := new(SalesmanDeliverItemReq_CmdId)
	*p = x
	return p
}

func (x SalesmanDeliverItemReq_CmdId) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SalesmanDeliverItemReq_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_SalesmanDeliverItemReq_proto_enumTypes[0].Descriptor()
}

func (SalesmanDeliverItemReq_CmdId) Type() protoreflect.EnumType {
	return &file_SalesmanDeliverItemReq_proto_enumTypes[0]
}

func (x SalesmanDeliverItemReq_CmdId) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SalesmanDeliverItemReq_CmdId.Descriptor instead.
func (SalesmanDeliverItemReq_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_SalesmanDeliverItemReq_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_SalesmanDeliverItemReq_proto_rawDesc = []byte{
	...
	0x72, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x65, 0x71, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9d,
	0x01, 0x0a, 0x16, 0x53, 0x61, 0x6c, 0x65, 0x73, 0x6d, 0x61, 0x6e, 0x44, 0x65, 0x6c, 0x69, 0x76,
	0x65, 0x72, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x65, 0x71, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x63, 0x68,
	...
	0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xef, 0x0f, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e,
...
var file_SalesmanDeliverItemReq_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_SalesmanDeliverItemReq_proto_goTypes = []interface{}{
	(SalesmanDeliverItemReq_CmdId)(0), // 0: SalesmanDeliverItemReq.CmdId
	(*SalesmanDeliverItemReq)(nil),    // 1: SalesmanDeliverItemReq
}
...
func file_SalesmanDeliverItemReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_SalesmanDeliverItemReq_proto_enumTypes,
