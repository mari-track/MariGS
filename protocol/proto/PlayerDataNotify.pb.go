...
const (
	...
	PlayerDataNotify_CMD_ID           PlayerDataNotify_CmdId = 108
...
type PlayerDataNotify struct {
	...
	IsFirstLoginToday bool                  `protobuf:"varint,3,opt,name=is_first_login_today,json=isFirstLoginToday,proto3" json:"is_first_login_today,omitempty"`
	RegionId          uint32                `protobuf:"varint,4,opt,name=region_id,json=regionId,proto3" json:"region_id,omitempty"`
	PropMap           map[uint32]*PropValue `protobuf:"bytes,6,rep,name=prop_map,json=propMap,proto3" json:"prop_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_PlayerDataNotify_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xef, 0x02, 0x0a, 0x10, 0x50, 0x6c,
	...
	0x09, 0x52, 0x08, 0x6e, 0x69, 0x63, 0x6b, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x73,
	0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04,
	0x52, 0x0a, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x2f, 0x0a, 0x14,
	0x69, 0x73, 0x5f, 0x66, 0x69, 0x72, 0x73, 0x74, 0x5f, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x5f, 0x74,
	0x6f, 0x64, 0x61, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x11, 0x69, 0x73, 0x46, 0x69,
	...
	0x6f, 0x70, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x50,
	...
	0x12, 0x0a, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0x6c, 0x12, 0x13, 0x0a, 0x0f,
...
var file_PlayerDataNotify_proto_goTypes = []interface{}{
	(PlayerDataNotify_CmdId)(0), // 0: PlayerDataNotify.CmdId
	(*PlayerDataNotify)(nil),    // 1: PlayerDataNotify
	nil,                         // 2: PlayerDataNotify.PropMapEntry
	(*PropValue)(nil),           // 3: PropValue
}
var file_PlayerDataNotify_proto_depIdxs = []int32{
	2, // 0: PlayerDataNotify.prop_map:type_name -> PlayerDataNotify.PropMapEntry
	3, // 1: PlayerDataNotify.PropMapEntry.value:type_name -> PropValue
