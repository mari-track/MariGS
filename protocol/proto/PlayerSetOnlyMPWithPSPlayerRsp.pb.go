...
const (
	...
	PlayerSetOnlyMPWithPSPlayerRsp_CMD_ID           PlayerSetOnlyMPWithPSPlayerRsp_CmdId = 1812
...
func (PlayerSetOnlyMPWithPSPlayerRsp_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_PlayerSetOnlyMPWithPSPlayerRsp_proto_enumTypes[0].Descriptor()
}

func (PlayerSetOnlyMPWithPSPlayerRsp_CmdId) Type() protoreflect.EnumType {
	return &file_PlayerSetOnlyMPWithPSPlayerRsp_proto_enumTypes[0]
}
...
func (PlayerSetOnlyMPWithPSPlayerRsp_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_PlayerSetOnlyMPWithPSPlayerRsp_proto_rawDescGZIP(), []int{0, 0}
}
...
type PlayerSetOnlyMPWithPSPlayerRsp struct {
	...
	IsOnly  bool  `protobuf:"varint,2,opt,name=is_only,json=isOnly,proto3" json:"is_only,omitempty"`
}
...
var file_PlayerSetOnlyMPWithPSPlayerRsp_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa2, 0x01,
	...
	0x05, 0x52, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x69, 0x73,
	0x5f, 0x6f, 0x6e, 0x6c, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x69, 0x73, 0x4f,
	0x6e, 0x6c, 0x79, 0x22, 0x4d, 0x0a, 0x05, 0x43, 0x6d, 0x64, 0x49, 0x64, 0x12, 0x08, 0x0a, 0x04,
	0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44,
	0x10, 0x94, 0x0e, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f, 0x43, 0x48, 0x41, 0x4e,
...
var file_PlayerSetOnlyMPWithPSPlayerRsp_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_PlayerSetOnlyMPWithPSPlayerRsp_proto_goTypes = []interface{}{
	(PlayerSetOnlyMPWithPSPlayerRsp_CmdId)(0), // 0: proto.PlayerSetOnlyMPWithPSPlayerRsp.CmdId
	(*PlayerSetOnlyMPWithPSPlayerRsp)(nil),    // 1: proto.PlayerSetOnlyMPWithPSPlayerRsp
}
...
func file_PlayerSetOnlyMPWithPSPlayerRsp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_PlayerSetOnlyMPWithPSPlayerRsp_proto_enumTypes,
