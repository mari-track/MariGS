...
type SeaLampContributeItemReq_CmdId int32

const (
	SeaLampContributeItemReq_NONE             SeaLampContributeItemReq_CmdId = 0
	SeaLampContributeItemReq_CMD_ID           SeaLampContributeItemReq_CmdId = 2020
	SeaLampContributeItemReq_ENET_CHANNEL_ID  SeaLampContributeItemReq_CmdId = 0
	SeaLampContributeItemReq_ENET_IS_RELIABLE SeaLampContributeItemReq_CmdId = 1
	SeaLampContributeItemReq_IS_ALLOW_CLIENT  SeaLampContributeItemReq_CmdId = 1
)

// Enum value maps for SeaLampContributeItemReq_CmdId.
var (
	SeaLampContributeItemReq_CmdId_name = map[int32]string{
		0:    "NONE",
		2020: "CMD_ID",
	...
	SeaLampContributeItemReq_CmdId_value = map[string]int32{
		"NONE":             0,
		"CMD_ID":           2020,
		"ENET_CHANNEL_ID":  0,
		"ENET_IS_RELIABLE": 1,
...
func (x SeaLampContributeItemReq_CmdId) Enum() *SeaLampContributeItemReq_CmdId {
	p := new(SeaLampContributeItemReq_CmdId)
	*p = x
	return p
}

func (x SeaLampContributeItemReq_CmdId) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SeaLampContributeItemReq_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_SeaLampContributeItemReq_proto_enumTypes[0].Descriptor()
}

func (SeaLampContributeItemReq_CmdId) Type() protoreflect.EnumType {
	return &file_SeaLampContributeItemReq_proto_enumTypes[0]
}

func (x SeaLampContributeItemReq_CmdId) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SeaLampContributeItemReq_CmdId.Descriptor instead.
func (SeaLampContributeItemReq_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_SeaLampContributeItemReq_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_SeaLampContributeItemReq_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xce, 0x01, 0x0a, 0x18, 0x53, 0x65, 0x61,
	0x4c, 0x61, 0x6d, 0x70, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x49, 0x74,
	0x65, 0x6d, 0x52, 0x65, 0x71, 0x12, 0x1f, 0x0a, 0x0b, 0x61, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74,
	0x79, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x61, 0x63, 0x74, 0x69,
	0x76, 0x69, 0x74, 0x79, 0x49, 0x64, 0x12, 0x2d, 0x0a, 0x09, 0x69, 0x74, 0x65, 0x6d, 0x5f, 0x6c,
	...
	0x6d, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x62, 0x0a, 0x05, 0x43, 0x6d, 0x64, 0x49, 0x64, 0x12, 0x08,
	0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f,
	0x49, 0x44, 0x10, 0xe4, 0x0f, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f, 0x43, 0x48,
...
var file_SeaLampContributeItemReq_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_SeaLampContributeItemReq_proto_goTypes = []interface{}{
	(SeaLampContributeItemReq_CmdId)(0), // 0: proto.SeaLampContributeItemReq.CmdId
	(*SeaLampContributeItemReq)(nil),    // 1: proto.SeaLampContributeItemReq
	(*ItemParam)(nil),                   // 2: proto.ItemParam
}
var file_SeaLampContributeItemReq_proto_depIdxs = []int32{
	2, // 0: proto.SeaLampContributeItemReq.item_list:type_name -> proto.ItemParam
...
func file_SeaLampContributeItemReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_SeaLampContributeItemReq_proto_enumTypes,
