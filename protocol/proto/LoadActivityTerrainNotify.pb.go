...
type LoadActivityTerrainNotify_CmdId int32

const (
	LoadActivityTerrainNotify_NONE             LoadActivityTerrainNotify_CmdId = 0
	LoadActivityTerrainNotify_CMD_ID           LoadActivityTerrainNotify_CmdId = 2024
	LoadActivityTerrainNotify_ENET_CHANNEL_ID  LoadActivityTerrainNotify_CmdId = 0
	LoadActivityTerrainNotify_ENET_IS_RELIABLE LoadActivityTerrainNotify_CmdId = 1
	LoadActivityTerrainNotify_IS_ALLOW_CLIENT  LoadActivityTerrainNotify_CmdId = 1
)

// Enum value maps for LoadActivityTerrainNotify_CmdId.
var (
	LoadActivityTerrainNotify_CmdId_name = map[int32]string{
		0:    "NONE",
		2024: "CMD_ID",
	...
	LoadActivityTerrainNotify_CmdId_value = map[string]int32{
		"NONE":             0,
		"CMD_ID":           2024,
		"ENET_CHANNEL_ID":  0,
		"ENET_IS_RELIABLE": 1,
...
func (x LoadActivityTerrainNotify_CmdId) Enum() *LoadActivityTerrainNotify_CmdId {
	p := new(LoadActivityTerrainNotify_CmdId)
	*p = x
	return p
}

func (x LoadActivityTerrainNotify_CmdId) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (LoadActivityTerrainNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_LoadActivityTerrainNotify_proto_enumTypes[0].Descriptor()
}

func (LoadActivityTerrainNotify_CmdId) Type() protoreflect.EnumType {
	return &file_LoadActivityTerrainNotify_proto_enumTypes[0]
}

func (x LoadActivityTerrainNotify_CmdId) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use LoadActivityTerrainNotify_CmdId.Descriptor instead.
func (LoadActivityTerrainNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_LoadActivityTerrainNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_LoadActivityTerrainNotify_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa0, 0x01, 0x0a, 0x19, 0x4c, 0x6f, 0x61,
	0x64, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x54, 0x65, 0x72, 0x72, 0x61, 0x69, 0x6e,
	...
	0x69, 0x76, 0x69, 0x74, 0x79, 0x49, 0x64, 0x22, 0x62, 0x0a, 0x05, 0x43, 0x6d, 0x64, 0x49, 0x64,
	0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d,
	0x44, 0x5f, 0x49, 0x44, 0x10, 0xe8, 0x0f, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f,
...
var file_LoadActivityTerrainNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_LoadActivityTerrainNotify_proto_goTypes = []interface{}{
	(LoadActivityTerrainNotify_CmdId)(0), // 0: proto.LoadActivityTerrainNotify.CmdId
	(*LoadActivityTerrainNotify)(nil),    // 1: proto.LoadActivityTerrainNotify
}
...
func file_LoadActivityTerrainNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_LoadActivityTerrainNotify_proto_enumTypes,
