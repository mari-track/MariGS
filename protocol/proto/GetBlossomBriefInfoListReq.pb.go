...
const (
	...
	GetBlossomBriefInfoListReq_CMD_ID           GetBlossomBriefInfoListReq_CmdId = 2701
...
func (GetBlossomBriefInfoListReq_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_GetBlossomBriefInfoListReq_proto_enumTypes[0].Descriptor()
}

func (GetBlossomBriefInfoListReq_CmdId) Type() protoreflect.EnumType {
	return &file_GetBlossomBriefInfoListReq_proto_enumTypes[0]
}
...
func (GetBlossomBriefInfoListReq_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_GetBlossomBriefInfoListReq_proto_rawDescGZIP(), []int{0, 0}
}
...
type GetBlossomBriefInfoListReq struct {
	...
	CityIdList []uint32 `protobuf:"varint,1,rep,packed,name=city_id_list,json=cityIdList,proto3" json:"city_id_list,omitempty"`
}
...
var file_GetBlossomBriefInfoListReq_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xa2, 0x01, 0x0a, 0x1a, 0x47, 0x65, 0x74, 0x42, 0x6c, 0x6f, 0x73, 0x73, 0x6f,
	0x6d, 0x42, 0x72, 0x69, 0x65, 0x66, 0x49, 0x6e, 0x66, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65,
	0x71, 0x12, 0x20, 0x0a, 0x0c, 0x63, 0x69, 0x74, 0x79, 0x5f, 0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73,
	0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0a, 0x63, 0x69, 0x74, 0x79, 0x49, 0x64, 0x4c,
	...
	0x10, 0x8d, 0x15, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f, 0x43, 0x48, 0x41, 0x4e,
...
var file_GetBlossomBriefInfoListReq_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_GetBlossomBriefInfoListReq_proto_goTypes = []interface{}{
	(GetBlossomBriefInfoListReq_CmdId)(0), // 0: GetBlossomBriefInfoListReq.CmdId
	(*GetBlossomBriefInfoListReq)(nil),    // 1: GetBlossomBriefInfoListReq
}
...
func file_GetBlossomBriefInfoListReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_GetBlossomBriefInfoListReq_proto_enumTypes,
