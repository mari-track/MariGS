...
const (
	...
	DungeonGetStatueDropRsp_CMD_ID           DungeonGetStatueDropRsp_CmdId = 923
...
func (DungeonGetStatueDropRsp_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_DungeonGetStatueDropRsp_proto_enumTypes[0].Descriptor()
}

func (DungeonGetStatueDropRsp_CmdId) Type() protoreflect.EnumType {
	return &file_DungeonGetStatueDropRsp_proto_enumTypes[0]
}
...
func (DungeonGetStatueDropRsp_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_DungeonGetStatueDropRsp_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_DungeonGetStatueDropRsp_proto_rawDesc = []byte{
	...
	0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x82, 0x01, 0x0a, 0x17, 0x44, 0x75, 0x6e, 0x67, 0x65,
	0x6f, 0x6e, 0x47, 0x65, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x65, 0x44, 0x72, 0x6f, 0x70, 0x52,
	...
	0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0x9b, 0x07, 0x12, 0x13, 0x0a, 0x0f,
...
var file_DungeonGetStatueDropRsp_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_DungeonGetStatueDropRsp_proto_goTypes = []interface{}{
	(DungeonGetStatueDropRsp_CmdId)(0), // 0: proto.DungeonGetStatueDropRsp.CmdId
	(*DungeonGetStatueDropRsp)(nil),    // 1: proto.DungeonGetStatueDropRsp
}
...
func file_DungeonGetStatueDropRsp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_DungeonGetStatueDropRsp_proto_enumTypes,
