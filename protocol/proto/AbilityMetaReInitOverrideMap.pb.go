...
type AbilityMetaReInitOverrideMap struct {
	...
	OverrideMap []*AbilityScalarValueEntry `protobuf:"bytes,1,rep,name=override_map,json=overrideMap,proto3" json:"override_map,omitempty"`
}
...
var file_AbilityMetaReInitOverrideMap_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b,
