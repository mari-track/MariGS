...
const (
	...
	JoinPlayerSceneReq_CMD_ID           JoinPlayerSceneReq_CmdId = 269
...
func (JoinPlayerSceneReq_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_JoinPlayerSceneReq_proto_enumTypes[0].Descriptor()
}

func (JoinPlayerSceneReq_CmdId) Type() protoreflect.EnumType {
	return &file_JoinPlayerSceneReq_proto_enumTypes[0]
}
...
func (JoinPlayerSceneReq_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_JoinPlayerSceneReq_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_JoinPlayerSceneReq_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x97, 0x01, 0x0a, 0x12, 0x4a, 0x6f, 0x69, 0x6e, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72,
	0x53, 0x63, 0x65, 0x6e, 0x65, 0x52, 0x65, 0x71, 0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x61, 0x72, 0x67,
	...
	0x44, 0x5f, 0x49, 0x44, 0x10, 0x8d, 0x02, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f,
...
var file_JoinPlayerSceneReq_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_JoinPlayerSceneReq_proto_goTypes = []interface{}{
	(JoinPlayerSceneReq_CmdId)(0), // 0: proto.JoinPlayerSceneReq.CmdId
	(*JoinPlayerSceneReq)(nil),    // 1: proto.JoinPlayerSceneReq
}
...
func file_JoinPlayerSceneReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_JoinPlayerSceneReq_proto_enumTypes,
