...
const (
	...
	CheckSegmentCRCNotify_CMD_ID           CheckSegmentCRCNotify_CmdId = 19
...
func (CheckSegmentCRCNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_CheckSegmentCRCNotify_proto_enumTypes[0].Descriptor()
}

func (CheckSegmentCRCNotify_CmdId) Type() protoreflect.EnumType {
	return &file_CheckSegmentCRCNotify_proto_enumTypes[0]
}
...
func (CheckSegmentCRCNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_CheckSegmentCRCNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_CheckSegmentCRCNotify_proto_rawDesc = []byte{
	...
	0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x96, 0x01, 0x0a, 0x15, 0x43, 0x68, 0x65, 0x63,
	0x6b, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x43, 0x52, 0x43, 0x4e, 0x6f, 0x74, 0x69, 0x66,
	0x79, 0x12, 0x2f, 0x0a, 0x09, 0x69, 0x6e, 0x66, 0x6f, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x53, 0x65, 0x67,
	0x6d, 0x65, 0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x08, 0x69, 0x6e, 0x66, 0x6f, 0x4c, 0x69,
...
var file_CheckSegmentCRCNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_CheckSegmentCRCNotify_proto_goTypes = []interface{}{
	(CheckSegmentCRCNotify_CmdId)(0), // 0: proto.CheckSegmentCRCNotify.CmdId
	(*CheckSegmentCRCNotify)(nil),    // 1: proto.CheckSegmentCRCNotify
	(*SegmentInfo)(nil),              // 2: proto.SegmentInfo
}
var file_CheckSegmentCRCNotify_proto_depIdxs = []int32{
	2, // 0: proto.CheckSegmentCRCNotify.info_list:type_name -> proto.SegmentInfo
...
func file_CheckSegmentCRCNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_CheckSegmentCRCNotify_proto_enumTypes,
