...
const (
	...
	PlayerRandomCookRsp_CMD_ID           PlayerRandomCookRsp_CmdId = 129
...
func (PlayerRandomCookRsp_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_PlayerRandomCookRsp_proto_enumTypes[0].Descriptor()
}

func (PlayerRandomCookRsp_CmdId) Type() protoreflect.EnumType {
	return &file_PlayerRandomCookRsp_proto_enumTypes[0]
}
...
func (PlayerRandomCookRsp_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_PlayerRandomCookRsp_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *PlayerRandomCookRsp) GetRetcode() uint32 {
	if x != nil {
		return x.Retcode
	}
	return 0
...
var file_PlayerRandomCookRsp_proto_rawDesc = []byte{
	...
	0x6f, 0x6b, 0x52, 0x73, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x7e, 0x0a, 0x13, 0x50,
	...
	0x01, 0x28, 0x0d, 0x52, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x22, 0x4d, 0x0a, 0x05,
	0x43, 0x6d, 0x64, 0x49, 0x64, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12,
	0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0x81, 0x01, 0x12, 0x13, 0x0a, 0x0f,
...
var file_PlayerRandomCookRsp_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_PlayerRandomCookRsp_proto_goTypes = []interface{}{
	(PlayerRandomCookRsp_CmdId)(0), // 0: PlayerRandomCookRsp.CmdId
	(*PlayerRandomCookRsp)(nil),    // 1: PlayerRandomCookRsp
}
...
func file_PlayerRandomCookRsp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_PlayerRandomCookRsp_proto_enumTypes,
