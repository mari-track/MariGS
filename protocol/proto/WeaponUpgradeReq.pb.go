...
const (
	...
	WeaponUpgradeReq_CMD_ID           WeaponUpgradeReq_CmdId = 619
...
func (WeaponUpgradeReq_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_WeaponUpgradeReq_proto_enumTypes[0].Descriptor()
}

func (WeaponUpgradeReq_CmdId) Type() protoreflect.EnumType {
	return &file_WeaponUpgradeReq_proto_enumTypes[0]
}
...
func (WeaponUpgradeReq_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_WeaponUpgradeReq_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_WeaponUpgradeReq_proto_rawDesc = []byte{
	...
	0x22, 0x91, 0x02, 0x0a, 0x10, 0x57, 0x65, 0x61, 0x70, 0x6f, 0x6e, 0x55, 0x70, 0x67, 0x72, 0x61,
	0x64, 0x65, 0x52, 0x65, 0x71, 0x12, 0x2c, 0x0a, 0x12, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f,
	...
	0x75, 0x69, 0x64, 0x12, 0x31, 0x0a, 0x15, 0x66, 0x6f, 0x6f, 0x64, 0x5f, 0x77, 0x65, 0x61, 0x70,
	...
	0x69, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x38, 0x0a, 0x0f, 0x69, 0x74, 0x65, 0x6d, 0x5f, 0x70,
	...
	0x45, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xeb, 0x04,
...
var file_WeaponUpgradeReq_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_WeaponUpgradeReq_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_WeaponUpgradeReq_proto_goTypes = []interface{}{
	(WeaponUpgradeReq_CmdId)(0), // 0: proto.WeaponUpgradeReq.CmdId
	(*WeaponUpgradeReq)(nil),    // 1: proto.WeaponUpgradeReq
	(*ItemParam)(nil),           // 2: proto.ItemParam
}
var file_WeaponUpgradeReq_proto_depIdxs = []int32{
	2, // 0: proto.WeaponUpgradeReq.item_param_list:type_name -> proto.ItemParam
...
func file_WeaponUpgradeReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_WeaponUpgradeReq_proto_enumTypes,
