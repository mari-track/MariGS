...
const (
	...
	EvtBeingHitsCombineNotify_CMD_ID           EvtBeingHitsCombineNotify_CmdId = 337
...
type EvtBeingHitsCombineNotify struct {
	...
	EvtBeingHitInfoList []*EvtBeingHitInfo `protobuf:"bytes,2,rep,name=evt_being_hit_info_list,json=evtBeingHitInfoList,proto3" json:"evt_being_hit_info_list,omitempty"`
}
...
var file_EvtBeingHitsCombineNotify_proto_rawDesc = []byte{
	...
	0x74, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf8, 0x01, 0x0a, 0x19,
	...
	0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x45, 0x76,
	...
	0xd1, 0x02, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f, 0x43, 0x48, 0x41, 0x4e, 0x4e,
...
var file_EvtBeingHitsCombineNotify_proto_goTypes = []interface{}{
	(EvtBeingHitsCombineNotify_CmdId)(0), // 0: EvtBeingHitsCombineNotify.CmdId
	(*EvtBeingHitsCombineNotify)(nil),    // 1: EvtBeingHitsCombineNotify
	(ForwardType)(0),                     // 2: ForwardType
	(*EvtBeingHitInfo)(nil),              // 3: EvtBeingHitInfo
}
var file_EvtBeingHitsCombineNotify_proto_depIdxs = []int32{
	2, // 0: EvtBeingHitsCombineNotify.forward_type:type_name -> ForwardType
	3, // 1: EvtBeingHitsCombineNotify.evt_being_hit_info_list:type_name -> EvtBeingHitInfo
