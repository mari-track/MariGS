...
const (
	...
	SceneTimeNotify_CMD_ID           SceneTimeNotify_CmdId = 281
...
func (SceneTimeNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_SceneTimeNotify_proto_enumTypes[0].Descriptor()
}

func (SceneTimeNotify_CmdId) Type() protoreflect.EnumType {
	return &file_SceneTimeNotify_proto_enumTypes[0]
}
...
func (SceneTimeNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_SceneTimeNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
type SceneTimeNotify struct {
	...
	SceneTime uint64 `protobuf:"varint,3,opt,name=scene_time,json=sceneTime,proto3" json:"scene_time,omitempty"`
}
...
var file_SceneTimeNotify_proto_rawDesc = []byte{
	...
	0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb7,
	0x01, 0x0a, 0x0f, 0x53, 0x63, 0x65, 0x6e, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x4e, 0x6f, 0x74, 0x69,
	...
	0x52, 0x08, 0x69, 0x73, 0x50, 0x61, 0x75, 0x73, 0x65, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x63,
	0x65, 0x6e, 0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09,
	0x73, 0x63, 0x65, 0x6e, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x4d, 0x0a, 0x05, 0x43, 0x6d, 0x64,
	0x49, 0x64, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x06,
	0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0x99, 0x02, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45,
...
var file_SceneTimeNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_SceneTimeNotify_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_SceneTimeNotify_proto_goTypes = []interface{}{
	(SceneTimeNotify_CmdId)(0), // 0: proto.SceneTimeNotify.CmdId
	(*SceneTimeNotify)(nil),    // 1: proto.SceneTimeNotify
}
...
func file_SceneTimeNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_SceneTimeNotify_proto_enumTypes,
