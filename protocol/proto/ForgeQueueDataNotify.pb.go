...
var file_ForgeQueueDataNotify_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xd8, 0x02, 0x0a, 0x14, 0x46, 0x6f, 0x72, 0x67, 0x65, 0x51, 0x75, 0x65, 0x75,
	...
	0x75, 0x65, 0x75, 0x65, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0d, 0x52,
	...
	0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xfc, 0x04, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45,
...
var file_ForgeQueueDataNotify_proto_goTypes = []interface{}{
	(ForgeQueueDataNotify_CmdId)(0), // 0: ForgeQueueDataNotify.CmdId
	(*ForgeQueueDataNotify)(nil),    // 1: ForgeQueueDataNotify
	nil,                             // 2: ForgeQueueDataNotify.ForgeQueueMapEntry
	(*ForgeQueueData)(nil),          // 3: ForgeQueueData
}
var file_ForgeQueueDataNotify_proto_depIdxs = []int32{
	2, // 0: ForgeQueueDataNotify.forge_queue_map:type_name -> ForgeQueueDataNotify.ForgeQueueMapEntry
	3, // 1: ForgeQueueDataNotify.ForgeQueueMapEntry.value:type_name -> ForgeQueueData
