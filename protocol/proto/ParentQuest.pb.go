...
var file_ParentQuest_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xba, 0x02, 0x0a, 0x0b, 0x50, 0x61,
	...
	0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x3b, 0x70, 0x72, 0x6f,
...
var file_ParentQuest_proto_goTypes = []interface{}{
	...
	(*ChildQuest)(nil),            // 1: proto.ChildQuest
	(*ParentQuestRandomInfo)(nil), // 2: proto.ParentQuestRandomInfo
}
var file_ParentQuest_proto_depIdxs = []int32{
	1, // 0: proto.ParentQuest.child_quest_list:type_name -> proto.ChildQuest
	2, // 1: proto.ParentQuest.random_info:type_name -> proto.ParentQuestRandomInfo
