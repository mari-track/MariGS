...
const (
	...
	CookRecipeDataNotify_CMD_ID           CookRecipeDataNotify_CmdId = 131
...
func (CookRecipeDataNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_CookRecipeDataNotify_proto_enumTypes[0].Descriptor()
}

func (CookRecipeDataNotify_CmdId) Type() protoreflect.EnumType {
	return &file_CookRecipeDataNotify_proto_enumTypes[0]
}
...
func (CookRecipeDataNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_CookRecipeDataNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_CookRecipeDataNotify_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x97, 0x01, 0x0a, 0x14, 0x43, 0x6f, 0x6f, 0x6b, 0x52, 0x65, 0x63, 0x69, 0x70,
	0x65, 0x44, 0x61, 0x74, 0x61, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x30, 0x0a, 0x0b, 0x72,
	0x65, 0x63, 0x69, 0x70, 0x65, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x0f, 0x2e, 0x43, 0x6f, 0x6f, 0x6b, 0x52, 0x65, 0x63, 0x69, 0x70, 0x65, 0x44, 0x61, 0x74,
	0x61, 0x52, 0x0a, 0x72, 0x65, 0x63, 0x69, 0x70, 0x65, 0x44, 0x61, 0x74, 0x61, 0x22, 0x4d, 0x0a,
	0x05, 0x43, 0x6d, 0x64, 0x49, 0x64, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00,
	0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0x83, 0x01, 0x12, 0x13, 0x0a,
...
var file_CookRecipeDataNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_CookRecipeDataNotify_proto_goTypes = []interface{}{
	(CookRecipeDataNotify_CmdId)(0), // 0: CookRecipeDataNotify.CmdId
	(*CookRecipeDataNotify)(nil),    // 1: CookRecipeDataNotify
	(*CookRecipeData)(nil),          // 2: CookRecipeData
}
var file_CookRecipeDataNotify_proto_depIdxs = []int32{
	2, // 0: CookRecipeDataNotify.recipe_data:type_name -> CookRecipeData
...
func file_CookRecipeDataNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_CookRecipeDataNotify_proto_enumTypes,
