...
const (
	...
	GetBargainDataRsp_CMD_ID           GetBargainDataRsp_CmdId = 428
...
func (GetBargainDataRsp_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_GetBargainDataRsp_proto_enumTypes[0].Descriptor()
}

func (GetBargainDataRsp_CmdId) Type() protoreflect.EnumType {
	return &file_GetBargainDataRsp_proto_enumTypes[0]
}
...
func (GetBargainDataRsp_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_GetBargainDataRsp_proto_rawDescGZIP(), []int{0, 0}
}
...
type GetBargainDataRsp struct {
	...
	BargainId uint32           `protobuf:"varint,2,opt,name=bargain_id,json=bargainId,proto3" json:"bargain_id,omitempty"`
	Snapshot  *BargainSnapshot `protobuf:"bytes,3,opt,name=snapshot,proto3" json:"snapshot,omitempty"`
}
...
var file_GetBargainDataRsp_proto_rawDesc = []byte{
	...
	0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xcf, 0x01, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x42,
	...
	0x69, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x62, 0x61, 0x72,
	0x67, 0x61, 0x69, 0x6e, 0x49, 0x64, 0x12, 0x32, 0x0a, 0x08, 0x73, 0x6e, 0x61, 0x70, 0x73, 0x68,
	0x6f, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x2e, 0x42, 0x61, 0x72, 0x67, 0x61, 0x69, 0x6e, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74,
	0x52, 0x08, 0x73, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x22, 0x4d, 0x0a, 0x05, 0x43, 0x6d,
	0x64, 0x49, 0x64, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0b, 0x0a,
	0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xac, 0x03, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e,
...
var file_GetBargainDataRsp_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_GetBargainDataRsp_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_GetBargainDataRsp_proto_goTypes = []interface{}{
	(GetBargainDataRsp_CmdId)(0), // 0: proto.GetBargainDataRsp.CmdId
	(*GetBargainDataRsp)(nil),    // 1: proto.GetBargainDataRsp
	(*BargainSnapshot)(nil),      // 2: proto.BargainSnapshot
}
var file_GetBargainDataRsp_proto_depIdxs = []int32{
	2, // 0: proto.GetBargainDataRsp.snapshot:type_name -> proto.BargainSnapshot
...
func file_GetBargainDataRsp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_GetBargainDataRsp_proto_enumTypes,
