...
const (
	...
	WorldPlayerInfoNotify_CMD_ID           WorldPlayerInfoNotify_CmdId = 3015
...
func (WorldPlayerInfoNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_WorldPlayerInfoNotify_proto_enumTypes[0].Descriptor()
}

func (WorldPlayerInfoNotify_CmdId) Type() protoreflect.EnumType {
	return &file_WorldPlayerInfoNotify_proto_enumTypes[0]
}
...
func (WorldPlayerInfoNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_WorldPlayerInfoNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
type WorldPlayerInfoNotify struct {
	...
	PlayerInfoList []*OnlinePlayerInfo `protobuf:"bytes,1,rep,name=player_info_list,json=playerInfoList,proto3" json:"player_info_list,omitempty"`
...
var file_WorldPlayerInfoNotify_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe6, 0x01, 0x0a,
	0x15, 0x57, 0x6f, 0x72, 0x6c, 0x64, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f,
	0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x41, 0x0a, 0x10, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72,
	...
	0x72, 0x49, 0x6e, 0x66, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x26, 0x0a, 0x0f, 0x70, 0x6c, 0x61,
	0x79, 0x65, 0x72, 0x5f, 0x75, 0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03,
	0x28, 0x0d, 0x52, 0x0d, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x55, 0x69, 0x64, 0x4c, 0x69, 0x73,
...
var file_WorldPlayerInfoNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_WorldPlayerInfoNotify_proto_goTypes = []interface{}{
	(WorldPlayerInfoNotify_CmdId)(0), // 0: proto.WorldPlayerInfoNotify.CmdId
	(*WorldPlayerInfoNotify)(nil),    // 1: proto.WorldPlayerInfoNotify
	(*OnlinePlayerInfo)(nil),         // 2: proto.OnlinePlayerInfo
}
var file_WorldPlayerInfoNotify_proto_depIdxs = []int32{
	2, // 0: proto.WorldPlayerInfoNotify.player_info_list:type_name -> proto.OnlinePlayerInfo
...
func file_WorldPlayerInfoNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_WorldPlayerInfoNotify_proto_enumTypes,
