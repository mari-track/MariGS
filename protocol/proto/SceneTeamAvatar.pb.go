...
type SceneTeamAvatar struct {
	...
	SceneAvatarInfo     *SceneAvatarInfo      `protobuf:"bytes,6,opt,name=scene_avatar_info,json=sceneAvatarInfo,proto3" json:"scene_avatar_info,omitempty"`
	...
	ServerBuffList      []*ServerBuff         `protobuf:"bytes,8,rep,name=server_buff_list,json=serverBuffList,proto3" json:"server_buff_list,omitempty"`
	WeaponGuid          uint64                `protobuf:"varint,10,opt,name=weapon_guid,json=weaponGuid,proto3" json:"weapon_guid,omitempty"`
	WeaponEntityId      uint32                `protobuf:"varint,11,opt,name=weapon_entity_id,json=weaponEntityId,proto3" json:"weapon_entity_id,omitempty"`
	...
	AbilityControlBlock *AbilityControlBlock  `protobuf:"bytes,13,opt,name=ability_control_block,json=abilityControlBlock,proto3" json:"ability_control_block,omitempty"`
	IsReconnect         bool                  `protobuf:"varint,14,opt,name=is_reconnect,json=isReconnect,proto3" json:"is_reconnect,omitempty"`
}
...
var file_SceneTeamAvatar_proto_rawDesc = []byte{
	...
	0x53, 0x63, 0x65, 0x6e, 0x65, 0x41, 0x76, 0x61, 0x74, 0x61, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x10, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x42, 0x75, 0x66,
	0x66, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x10, 0x41, 0x76, 0x61, 0x74, 0x61, 0x72, 0x49,
	...
	,
	...
	0x28, 0x0d, 0x52, 0x08, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x49, 0x64, 0x12, 0x32, 0x0a, 0x0b,
	0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x05, 0x20, 0x01, 0x28,
	...
	0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x70, 0x72,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x12, 0x4b, 0x0a, 0x13, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x5f, 0x61,
	0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x07, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x1b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x41, 0x62, 0x69, 0x6c, 0x69, 0x74,
	...
	,
	...
	0x74, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x4e, 0x0a, 0x15, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74,
	0x79, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x18,
	0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x41, 0x62,
	...
	0x6c, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x21, 0x0a, 0x0c, 0x69, 0x73, 0x5f, 0x72, 0x65, 0x63,
	0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x69, 0x73,
	0x52, 0x65, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x3b,
...
var file_SceneTeamAvatar_proto_goTypes = []interface{}{
	...
	(*SceneAvatarInfo)(nil),      // 2: proto.SceneAvatarInfo
	(*AbilitySyncStateInfo)(nil), // 3: proto.AbilitySyncStateInfo
	(*ServerBuff)(nil),           // 4: proto.ServerBuff
	(*AbilityControlBlock)(nil),  // 5: proto.AbilityControlBlock
}
var file_SceneTeamAvatar_proto_depIdxs = []int32{
	1, // 0: proto.SceneTeamAvatar.avatar_info:type_name -> proto.AvatarInfo
	2, // 1: proto.SceneTeamAvatar.scene_avatar_info:type_name -> proto.SceneAvatarInfo
	3, // 2: proto.SceneTeamAvatar.avatar_ability_info:type_name -> proto.AbilitySyncStateInfo
	4, // 3: proto.SceneTeamAvatar.server_buff_list:type_name -> proto.ServerBuff
	3, // 4: proto.SceneTeamAvatar.weapon_ability_info:type_name -> proto.AbilitySyncStateInfo
