...
type DungeonCandidateTeamAvatar struct {
	...
	AvatarInfo *AvatarInfo `protobuf:"bytes,2,opt,name=avatar_info,json=avatarInfo,proto3" json:"avatar_info,omitempty"`
}
...
var file_DungeonCandidateTeamAvatar_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e,
