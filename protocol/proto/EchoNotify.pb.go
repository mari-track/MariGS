...
const (
	...
	EchoNotify_CMD_ID           EchoNotify_CmdId = 22
...
func (EchoNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_EchoNotify_proto_enumTypes[0].Descriptor()
}

func (EchoNotify_CmdId) Type() protoreflect.EnumType {
	return &file_EchoNotify_proto_enumTypes[0]
}
...
func (EchoNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_EchoNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_EchoNotify_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x8b, 0x01, 0x0a, 0x0a, 0x45, 0x63, 0x68, 0x6f, 0x4e, 0x6f, 0x74, 0x69, 0x66,
	0x79, 0x12, 0x15, 0x0a, 0x06, 0x73, 0x65, 0x71, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x05, 0x73, 0x65, 0x71, 0x49, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74,
	0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65,
	0x6e, 0x74, 0x22, 0x4c, 0x0a, 0x05, 0x43, 0x6d, 0x64, 0x49, 0x64, 0x12, 0x08, 0x0a, 0x04, 0x4e,
	0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0a, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10,
	0x16, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f, 0x43, 0x48, 0x41, 0x4e, 0x4e, 0x45,
...
var file_EchoNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_EchoNotify_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_EchoNotify_proto_goTypes = []interface{}{
	(EchoNotify_CmdId)(0), // 0: EchoNotify.CmdId
	(*EchoNotify)(nil),    // 1: EchoNotify
}
...
func file_EchoNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_EchoNotify_proto_enumTypes,
