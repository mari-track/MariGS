...
type SeaLampTakeContributionRewardReq_CmdId int32

const (
	SeaLampTakeContributionRewardReq_NONE             SeaLampTakeContributionRewardReq_CmdId = 0
	SeaLampTakeContributionRewardReq_CMD_ID           SeaLampTakeContributionRewardReq_CmdId = 2016
	SeaLampTakeContributionRewardReq_ENET_CHANNEL_ID  SeaLampTakeContributionRewardReq_CmdId = 0
	SeaLampTakeContributionRewardReq_ENET_IS_RELIABLE SeaLampTakeContributionRewardReq_CmdId = 1
	SeaLampTakeContributionRewardReq_IS_ALLOW_CLIENT  SeaLampTakeContributionRewardReq_CmdId = 1
)

// Enum value maps for SeaLampTakeContributionRewardReq_CmdId.
var (
	SeaLampTakeContributionRewardReq_CmdId_name = map[int32]string{
		0:    "NONE",
		2016: "CMD_ID",
	...
	SeaLampTakeContributionRewardReq_CmdId_value = map[string]int32{
		"NONE":             0,
		"CMD_ID":           2016,
		"ENET_CHANNEL_ID":  0,
		"ENET_IS_RELIABLE": 1,
...
func (x SeaLampTakeContributionRewardReq_CmdId) Enum() *SeaLampTakeContributionRewardReq_CmdId {
	p := new(SeaLampTakeContributionRewardReq_CmdId)
	*p = x
	return p
}

func (x SeaLampTakeContributionRewardReq_CmdId) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SeaLampTakeContributionRewardReq_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_SeaLampTakeContributionRewardReq_proto_enumTypes[0].Descriptor()
}

func (SeaLampTakeContributionRewardReq_CmdId) Type() protoreflect.EnumType {
	return &file_SeaLampTakeContributionRewardReq_proto_enumTypes[0]
}

func (x SeaLampTakeContributionRewardReq_CmdId) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SeaLampTakeContributionRewardReq_CmdId.Descriptor instead.
func (SeaLampTakeContributionRewardReq_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_SeaLampTakeContributionRewardReq_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_SeaLampTakeContributionRewardReq_proto_rawDesc = []byte{
	...
	,
...
var file_SeaLampTakeContributionRewardReq_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_SeaLampTakeContributionRewardReq_proto_goTypes = []interface{}{
	(SeaLampTakeContributionRewardReq_CmdId)(0), // 0: SeaLampTakeContributionRewardReq.CmdId
	(*SeaLampTakeContributionRewardReq)(nil),    // 1: SeaLampTakeContributionRewardReq
}
...
func file_SeaLampTakeContributionRewardReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_SeaLampTakeContributionRewardReq_proto_enumTypes,
