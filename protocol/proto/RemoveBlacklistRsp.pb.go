...
const (
	...
	RemoveBlacklistRsp_CMD_ID           RemoveBlacklistRsp_CmdId = 4030
...
func (RemoveBlacklistRsp_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_RemoveBlacklistRsp_proto_enumTypes[0].Descriptor()
}

func (RemoveBlacklistRsp_CmdId) Type() protoreflect.EnumType {
	return &file_RemoveBlacklistRsp_proto_enumTypes[0]
}
...
func (RemoveBlacklistRsp_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_RemoveBlacklistRsp_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_RemoveBlacklistRsp_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x73, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9c, 0x01, 0x0a, 0x12, 0x52,
	...
	0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xbe, 0x1f, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e,
...
var file_RemoveBlacklistRsp_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_RemoveBlacklistRsp_proto_goTypes = []interface{}{
	(RemoveBlacklistRsp_CmdId)(0), // 0: RemoveBlacklistRsp.CmdId
	(*RemoveBlacklistRsp)(nil),    // 1: RemoveBlacklistRsp
}
...
func file_RemoveBlacklistRsp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_RemoveBlacklistRsp_proto_enumTypes,
