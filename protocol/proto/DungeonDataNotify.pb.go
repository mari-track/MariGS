...
var file_DungeonDataNotify_proto_goTypes = []interface{}{
	(DungeonDataNotify_CmdId)(0), // 0: proto.DungeonDataNotify.CmdId
	(*DungeonDataNotify)(nil),    // 1: proto.DungeonDataNotify
	nil,                          // 2: proto.DungeonDataNotify.DungeonDataMapEntry
}
var file_DungeonDataNotify_proto_depIdxs = []int32{
	2, // 0: proto.DungeonDataNotify.dungeon_data_map:type_name -> proto.DungeonDataNotify.DungeonDataMapEntry
