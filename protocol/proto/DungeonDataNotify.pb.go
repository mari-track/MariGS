...
const (
	...
	DungeonDataNotify_CMD_ID           DungeonDataNotify_CmdId = 917
...
func (DungeonDataNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_DungeonDataNotify_proto_enumTypes[0].Descriptor()
}

func (DungeonDataNotify_CmdId) Type() protoreflect.EnumType {
	return &file_DungeonDataNotify_proto_enumTypes[0]
}
...
func (DungeonDataNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_DungeonDataNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_DungeonDataNotify_proto_rawDesc = []byte{
	...
	0x69, 0x66, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf7, 0x01, 0x0a, 0x11, 0x44, 0x75,
...
var file_DungeonDataNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_DungeonDataNotify_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_DungeonDataNotify_proto_goTypes = []interface{}{
	(DungeonDataNotify_CmdId)(0), // 0: DungeonDataNotify.CmdId
	(*DungeonDataNotify)(nil),    // 1: DungeonDataNotify
	nil,                          // 2: DungeonDataNotify.DungeonDataMapEntry
}
var file_DungeonDataNotify_proto_depIdxs = []int32{
	2, // 0: DungeonDataNotify.dungeon_data_map:type_name -> DungeonDataNotify.DungeonDataMapEntry
...
func file_DungeonDataNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_DungeonDataNotify_proto_enumTypes,
