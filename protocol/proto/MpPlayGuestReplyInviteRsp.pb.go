...
const (
	...
	MpPlayGuestReplyInviteRsp_CMD_ID           MpPlayGuestReplyInviteRsp_CmdId = 1821
...
func (MpPlayGuestReplyInviteRsp_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_MpPlayGuestReplyInviteRsp_proto_enumTypes[0].Descriptor()
}

func (MpPlayGuestReplyInviteRsp_CmdId) Type() protoreflect.EnumType {
	return &file_MpPlayGuestReplyInviteRsp_proto_enumTypes[0]
}
...
func (MpPlayGuestReplyInviteRsp_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_MpPlayGuestReplyInviteRsp_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_MpPlayGuestReplyInviteRsp_proto_rawDesc = []byte{
	...
	0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0x9d, 0x0e, 0x12, 0x13,
...
var file_MpPlayGuestReplyInviteRsp_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_MpPlayGuestReplyInviteRsp_proto_goTypes = []interface{}{
	(MpPlayGuestReplyInviteRsp_CmdId)(0), // 0: proto.MpPlayGuestReplyInviteRsp.CmdId
	(*MpPlayGuestReplyInviteRsp)(nil),    // 1: proto.MpPlayGuestReplyInviteRsp
}
...
func file_MpPlayGuestReplyInviteRsp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_MpPlayGuestReplyInviteRsp_proto_enumTypes,
