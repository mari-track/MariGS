...
const (
	...
	EvtDestroyGadgetNotify_CMD_ID           EvtDestroyGadgetNotify_CmdId = 306
...
func (EvtDestroyGadgetNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_EvtDestroyGadgetNotify_proto_enumTypes[0].Descriptor()
}

func (EvtDestroyGadgetNotify_CmdId) Type() protoreflect.EnumType {
	return &file_EvtDestroyGadgetNotify_proto_enumTypes[0]
}
...
func (EvtDestroyGadgetNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_EvtDestroyGadgetNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_EvtDestroyGadgetNotify_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd0, 0x01, 0x0a, 0x16, 0x45, 0x76, 0x74,
	0x44, 0x65, 0x73, 0x74, 0x72, 0x6f, 0x79, 0x47, 0x61, 0x64, 0x67, 0x65, 0x74, 0x4e, 0x6f, 0x74,
	...
	0x44, 0x5f, 0x49, 0x44, 0x10, 0xb2, 0x02, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f,
...
var file_EvtDestroyGadgetNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_EvtDestroyGadgetNotify_proto_goTypes = []interface{}{
	(EvtDestroyGadgetNotify_CmdId)(0), // 0: proto.EvtDestroyGadgetNotify.CmdId
	(*EvtDestroyGadgetNotify)(nil),    // 1: proto.EvtDestroyGadgetNotify
	(ForwardType)(0),                  // 2: proto.ForwardType
}
var file_EvtDestroyGadgetNotify_proto_depIdxs = []int32{
	2, // 0: proto.EvtDestroyGadgetNotify.forward_type:type_name -> proto.ForwardType
...
func file_EvtDestroyGadgetNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_EvtDestroyGadgetNotify_proto_enumTypes,
