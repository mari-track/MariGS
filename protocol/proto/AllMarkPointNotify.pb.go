...
const (
	...
	AllMarkPointNotify_CMD_ID           AllMarkPointNotify_CmdId = 3012
...
func (AllMarkPointNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_AllMarkPointNotify_proto_enumTypes[0].Descriptor()
}

func (AllMarkPointNotify_CmdId) Type() protoreflect.EnumType {
	return &file_AllMarkPointNotify_proto_enumTypes[0]
}
...
func (AllMarkPointNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_AllMarkPointNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
type AllMarkPointNotify struct {
	...
	MarkList []*MapMarkPoint `protobuf:"bytes,1,rep,name=mark_list,json=markList,proto3" json:"mark_list,omitempty"`
}
...
var file_AllMarkPointNotify_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x6b, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8f,
	0x01, 0x0a, 0x12, 0x41, 0x6c, 0x6c, 0x4d, 0x61, 0x72, 0x6b, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x4e,
	0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x2a, 0x0a, 0x09, 0x6d, 0x61, 0x72, 0x6b, 0x5f, 0x6c, 0x69,
	0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x4d, 0x61, 0x70, 0x4d, 0x61,
	0x72, 0x6b, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x52, 0x08, 0x6d, 0x61, 0x72, 0x6b, 0x4c, 0x69, 0x73,
	0x74, 0x22, 0x4d, 0x0a, 0x05, 0x43, 0x6d, 0x64, 0x49, 0x64, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f,
	0x4e, 0x45, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xc4,
...
var file_AllMarkPointNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_AllMarkPointNotify_proto_goTypes = []interface{}{
	(AllMarkPointNotify_CmdId)(0), // 0: AllMarkPointNotify.CmdId
	(*AllMarkPointNotify)(nil),    // 1: AllMarkPointNotify
	(*MapMarkPoint)(nil),          // 2: MapMarkPoint
}
var file_AllMarkPointNotify_proto_depIdxs = []int32{
	2, // 0: AllMarkPointNotify.mark_list:type_name -> MapMarkPoint
...
func file_AllMarkPointNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_AllMarkPointNotify_proto_enumTypes,
