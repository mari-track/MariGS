...
const (
	...
	EvtBulletDeactiveNotify_CMD_ID           EvtBulletDeactiveNotify_CmdId = 314
...
func (EvtBulletDeactiveNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_EvtBulletDeactiveNotify_proto_enumTypes[0].Descriptor()
}

func (EvtBulletDeactiveNotify_CmdId) Type() protoreflect.EnumType {
	return &file_EvtBulletDeactiveNotify_proto_enumTypes[0]
}
...
func (EvtBulletDeactiveNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_EvtBulletDeactiveNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
type EvtBulletDeactiveNotify struct {
	...
	DisappearPos *Vector     `protobuf:"bytes,3,opt,name=disappear_pos,json=disappearPos,proto3" json:"disappear_pos,omitempty"`
}
...
var file_EvtBulletDeactiveNotify_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x85, 0x02, 0x0a, 0x17, 0x45, 0x76, 0x74, 0x42,
	...
	0x70, 0x65, 0x61, 0x72, 0x5f, 0x70, 0x6f, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x56, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x52, 0x0c, 0x64,
	0x69, 0x73, 0x61, 0x70, 0x70, 0x65, 0x61, 0x72, 0x50, 0x6f, 0x73, 0x22, 0x62, 0x0a, 0x05, 0x43,
	0x6d, 0x64, 0x49, 0x64, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0b,
	0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xba, 0x02, 0x12, 0x13, 0x0a, 0x0f, 0x45,
...
var file_EvtBulletDeactiveNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_EvtBulletDeactiveNotify_proto_goTypes = []interface{}{
	(EvtBulletDeactiveNotify_CmdId)(0), // 0: proto.EvtBulletDeactiveNotify.CmdId
	(*EvtBulletDeactiveNotify)(nil),    // 1: proto.EvtBulletDeactiveNotify
	(ForwardType)(0),                   // 2: proto.ForwardType
	(*Vector)(nil),                     // 3: proto.Vector
}
var file_EvtBulletDeactiveNotify_proto_depIdxs = []int32{
	2, // 0: proto.EvtBulletDeactiveNotify.forward_type:type_name -> proto.ForwardType
	3, // 1: proto.EvtBulletDeactiveNotify.disappear_pos:type_name -> proto.Vector
...
func file_EvtBulletDeactiveNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_EvtBulletDeactiveNotify_proto_enumTypes,
