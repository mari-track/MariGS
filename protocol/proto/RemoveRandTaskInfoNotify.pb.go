...
const (
	...
	RemoveRandTaskInfoNotify_CMD_ID           RemoveRandTaskInfoNotify_CmdId = 151
...
func (RemoveRandTaskInfoNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_RemoveRandTaskInfoNotify_proto_enumTypes[1].Descriptor()
}

func (RemoveRandTaskInfoNotify_CmdId) Type() protoreflect.EnumType {
	return &file_RemoveRandTaskInfoNotify_proto_enumTypes[1]
}
...
func (RemoveRandTaskInfoNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_RemoveRandTaskInfoNotify_proto_rawDescGZIP(), []int{0, 1}
}
...
type RemoveRandTaskInfoNotify struct {
	...
	RandTaskId uint32                                `protobuf:"varint,1,opt,name=rand_task_id,json=randTaskId,proto3" json:"rand_task_id,omitempty"`
	IsSucc     bool                                  `protobuf:"varint,2,opt,name=is_succ,json=isSucc,proto3" json:"is_succ,omitempty"`
	Reason     RemoveRandTaskInfoNotify_FinishReason `protobuf:"varint,3,opt,name=reason,proto3,enum=proto.RemoveRandTaskInfoNotify_FinishReason" json:"reason,omitempty"`
}
...
var file_RemoveRandTaskInfoNotify_proto_rawDesc = []byte{
	...
	0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xac, 0x02, 0x0a, 0x18, 0x52, 0x65, 0x6d, 0x6f,
	...
	0x6b, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x72, 0x61, 0x6e, 0x64,
	0x54, 0x61, 0x73, 0x6b, 0x49, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x69, 0x73, 0x5f, 0x73, 0x75, 0x63,
	0x63, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x69, 0x73, 0x53, 0x75, 0x63, 0x63, 0x12,
	0x44, 0x0a, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32,
	0x2c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x52, 0x61,
	...
	0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0x40, 0x0a, 0x0c, 0x46, 0x69, 0x6e, 0x69, 0x73, 0x68, 0x52,
	0x65, 0x61, 0x73, 0x6f, 0x6e, 0x12, 0x0b, 0x0a, 0x07, 0x44, 0x45, 0x46, 0x41, 0x55, 0x4c, 0x54,
	0x10, 0x00, 0x12, 0x09, 0x0a, 0x05, 0x43, 0x4c, 0x45, 0x41, 0x52, 0x10, 0x01, 0x12, 0x0c, 0x0a,
	0x08, 0x44, 0x49, 0x53, 0x54, 0x41, 0x4e, 0x43, 0x45, 0x10, 0x02, 0x12, 0x0a, 0x0a, 0x06, 0x46,
	0x49, 0x4e, 0x49, 0x53, 0x48, 0x10, 0x03, 0x22, 0x4d, 0x0a, 0x05, 0x43, 0x6d, 0x64, 0x49, 0x64,
	0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d,
	0x44, 0x5f, 0x49, 0x44, 0x10, 0x97, 0x01, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f,
...
var file_RemoveRandTaskInfoNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_RemoveRandTaskInfoNotify_proto_goTypes = []interface{}{
	...
	(RemoveRandTaskInfoNotify_CmdId)(0),        // 1: proto.RemoveRandTaskInfoNotify.CmdId
	(*RemoveRandTaskInfoNotify)(nil),           // 2: proto.RemoveRandTaskInfoNotify
}
