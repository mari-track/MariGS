...
type AbilityMixinWindSeedSpawner_AddSignal_ struct {
	AddSignal *AbilityMixinWindSeedSpawner_AddSignal `protobuf:"bytes,1,opt,name=add_signal,json=addSignal,proto3,oneof"`
}

type AbilityMixinWindSeedSpawner_RefreshSeed_ struct {
	RefreshSeed *AbilityMixinWindSeedSpawner_RefreshSeed `protobuf:"bytes,2,opt,name=refresh_seed,json=refreshSeed,proto3,oneof"`
}

type AbilityMixinWindSeedSpawner_CatchSeed_ struct {
	CatchSeed *AbilityMixinWindSeedSpawner_CatchSeed `protobuf:"bytes,3,opt,name=catch_seed,json=catchSeed,proto3,oneof"`
}
...
var file_AbilityMixinWindSeedSpawner_proto_rawDesc = []byte{
	...
	0x73, 0x69, 0x67, 0x6e, 0x61, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x70,
	...
	0x73, 0x68, 0x5f, 0x73, 0x65, 0x65, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2e, 0x2e,
	...
	0x63, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x73, 0x65, 0x65, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b,
	...
	0x69, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x70, 0x72, 0x6f, 0x74,
