...
const (
	...
	AnimatorForceSetAirMoveNotify_CMD_ID           AnimatorForceSetAirMoveNotify_CmdId = 335
...
func (AnimatorForceSetAirMoveNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_AnimatorForceSetAirMoveNotify_proto_enumTypes[0].Descriptor()
}

func (AnimatorForceSetAirMoveNotify_CmdId) Type() protoreflect.EnumType {
	return &file_AnimatorForceSetAirMoveNotify_proto_enumTypes[0]
}
...
func (AnimatorForceSetAirMoveNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_AnimatorForceSetAirMoveNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
type AnimatorForceSetAirMoveNotify struct {
	...
	InAirMove   bool        `protobuf:"varint,3,opt,name=in_air_move,json=inAirMove,proto3" json:"in_air_move,omitempty"`
}
...
var file_AnimatorForceSetAirMoveNotify_proto_rawDesc = []byte{
	...
	0xf7, 0x01, 0x0a, 0x1d, 0x41, 0x6e, 0x69, 0x6d, 0x61, 0x74, 0x6f, 0x72, 0x46, 0x6f, 0x72, 0x63,
	...
	0x69, 0x74, 0x79, 0x49, 0x64, 0x12, 0x1e, 0x0a, 0x0b, 0x69, 0x6e, 0x5f, 0x61, 0x69, 0x72, 0x5f,
	0x6d, 0x6f, 0x76, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x69, 0x6e, 0x41, 0x69,
	0x72, 0x4d, 0x6f, 0x76, 0x65, 0x22, 0x62, 0x0a, 0x05, 0x43, 0x6d, 0x64, 0x49, 0x64, 0x12, 0x08,
	0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f,
	0x49, 0x44, 0x10, 0xcf, 0x02, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f, 0x43, 0x48,
...
var file_AnimatorForceSetAirMoveNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_AnimatorForceSetAirMoveNotify_proto_goTypes = []interface{}{
	(AnimatorForceSetAirMoveNotify_CmdId)(0), // 0: proto.AnimatorForceSetAirMoveNotify.CmdId
	(*AnimatorForceSetAirMoveNotify)(nil),    // 1: proto.AnimatorForceSetAirMoveNotify
	(ForwardType)(0),                         // 2: proto.ForwardType
}
var file_AnimatorForceSetAirMoveNotify_proto_depIdxs = []int32{
	2, // 0: proto.AnimatorForceSetAirMoveNotify.forward_type:type_name -> proto.ForwardType
...
func file_AnimatorForceSetAirMoveNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_AnimatorForceSetAirMoveNotify_proto_enumTypes,
