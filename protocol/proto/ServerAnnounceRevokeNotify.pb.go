...
type ServerAnnounceRevokeNotify_CmdId int32

const (
	ServerAnnounceRevokeNotify_NONE             ServerAnnounceRevokeNotify_CmdId = 0
	ServerAnnounceRevokeNotify_CMD_ID           ServerAnnounceRevokeNotify_CmdId = 2023
	ServerAnnounceRevokeNotify_ENET_CHANNEL_ID  ServerAnnounceRevokeNotify_CmdId = 0
	ServerAnnounceRevokeNotify_ENET_IS_RELIABLE ServerAnnounceRevokeNotify_CmdId = 1
)

// Enum value maps for ServerAnnounceRevokeNotify_CmdId.
var (
	ServerAnnounceRevokeNotify_CmdId_name = map[int32]string{
		0:    "NONE",
		2023: "CMD_ID",
		// Duplicate value: 0: "ENET_CHANNEL_ID",
		1: "ENET_IS_RELIABLE",
	}
	ServerAnnounceRevokeNotify_CmdId_value = map[string]int32{
		"NONE":             0,
		"CMD_ID":           2023,
		"ENET_CHANNEL_ID":  0,
		"ENET_IS_RELIABLE": 1,
...
func (x ServerAnnounceRevokeNotify_CmdId) Enum() *ServerAnnounceRevokeNotify_CmdId {
	p := new(ServerAnnounceRevokeNotify_CmdId)
	*p = x
	return p
}

func (x ServerAnnounceRevokeNotify_CmdId) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ServerAnnounceRevokeNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_ServerAnnounceRevokeNotify_proto_enumTypes[0].Descriptor()
}

func (ServerAnnounceRevokeNotify_CmdId) Type() protoreflect.EnumType {
	return &file_ServerAnnounceRevokeNotify_proto_enumTypes[0]
}

func (x ServerAnnounceRevokeNotify_CmdId) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ServerAnnounceRevokeNotify_CmdId.Descriptor instead.
func (ServerAnnounceRevokeNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_ServerAnnounceRevokeNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
type ServerAnnounceRevokeNotify struct {
	...
	ConfigIdList []uint32 `protobuf:"varint,1,rep,packed,name=config_id_list,json=configIdList,proto3" json:"config_id_list,omitempty"`
}
...
var file_ServerAnnounceRevokeNotify_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x91, 0x01, 0x0a, 0x1a, 0x53, 0x65,
	0x72, 0x76, 0x65, 0x72, 0x41, 0x6e, 0x6e, 0x6f, 0x75, 0x6e, 0x63, 0x65, 0x52, 0x65, 0x76, 0x6f,
	0x6b, 0x65, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x24, 0x0a, 0x0e, 0x63, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x5f, 0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0d,
	0x52, 0x0c, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x49, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x4d,
	0x0a, 0x05, 0x43, 0x6d, 0x64, 0x49, 0x64, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10,
	0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xe7, 0x0f, 0x12, 0x13,
...
var file_ServerAnnounceRevokeNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_ServerAnnounceRevokeNotify_proto_goTypes = []interface{}{
	(ServerAnnounceRevokeNotify_CmdId)(0), // 0: proto.ServerAnnounceRevokeNotify.CmdId
	(*ServerAnnounceRevokeNotify)(nil),    // 1: proto.ServerAnnounceRevokeNotify
}
...
func file_ServerAnnounceRevokeNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_ServerAnnounceRevokeNotify_proto_enumTypes,
