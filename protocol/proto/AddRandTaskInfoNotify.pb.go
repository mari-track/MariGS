...
const (
	...
	AddRandTaskInfoNotify_CMD_ID           AddRandTaskInfoNotify_CmdId = 150
...
func (AddRandTaskInfoNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_AddRandTaskInfoNotify_proto_enumTypes[0].Descriptor()
}

func (AddRandTaskInfoNotify_CmdId) Type() protoreflect.EnumType {
	return &file_AddRandTaskInfoNotify_proto_enumTypes[0]
}
...
func (AddRandTaskInfoNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_AddRandTaskInfoNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_AddRandTaskInfoNotify_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xa9, 0x01, 0x0a, 0x15, 0x41, 0x64, 0x64, 0x52, 0x61, 0x6e, 0x64, 0x54, 0x61,
	0x73, 0x6b, 0x49, 0x6e, 0x66, 0x6f, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x20, 0x0a, 0x0c,
	0x72, 0x61, 0x6e, 0x64, 0x5f, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x0a, 0x72, 0x61, 0x6e, 0x64, 0x54, 0x61, 0x73, 0x6b, 0x49, 0x64, 0x12, 0x1f,
	0x0a, 0x03, 0x70, 0x6f, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x70, 0x72,
	...
	0x10, 0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0x96, 0x01, 0x12,
...
var file_AddRandTaskInfoNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_AddRandTaskInfoNotify_proto_goTypes = []interface{}{
	(AddRandTaskInfoNotify_CmdId)(0), // 0: proto.AddRandTaskInfoNotify.CmdId
	(*AddRandTaskInfoNotify)(nil),    // 1: proto.AddRandTaskInfoNotify
	(*Vector)(nil),                   // 2: proto.Vector
}
var file_AddRandTaskInfoNotify_proto_depIdxs = []int32{
	2, // 0: proto.AddRandTaskInfoNotify.pos:type_name -> proto.Vector
...
func file_AddRandTaskInfoNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_AddRandTaskInfoNotify_proto_enumTypes,
