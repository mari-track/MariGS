...
const (
	...
	EnterSceneReadyReq_CMD_ID           EnterSceneReadyReq_CmdId = 282
...
func (EnterSceneReadyReq_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_EnterSceneReadyReq_proto_enumTypes[0].Descriptor()
}

func (EnterSceneReadyReq_CmdId) Type() protoreflect.EnumType {
	return &file_EnterSceneReadyReq_proto_enumTypes[0]
}
...
func (EnterSceneReadyReq_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_EnterSceneReadyReq_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_EnterSceneReadyReq_proto_rawDesc = []byte{
	...
	0x79, 0x52, 0x65, 0x71, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa4, 0x01, 0x0a, 0x12, 0x45,
	0x6e, 0x74, 0x65, 0x72, 0x53, 0x63, 0x65, 0x6e, 0x65, 0x52, 0x65, 0x61, 0x64, 0x79, 0x52, 0x65,
	...
	0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0x9a, 0x02, 0x12, 0x13, 0x0a,
...
var file_EnterSceneReadyReq_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_EnterSceneReadyReq_proto_goTypes = []interface{}{
	(EnterSceneReadyReq_CmdId)(0), // 0: EnterSceneReadyReq.CmdId
	(*EnterSceneReadyReq)(nil),    // 1: EnterSceneReadyReq
}
...
func file_EnterSceneReadyReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_EnterSceneReadyReq_proto_enumTypes,
