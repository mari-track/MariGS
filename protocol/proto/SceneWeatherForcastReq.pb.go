...
const (
	...
	SceneWeatherForcastReq_CMD_ID           SceneWeatherForcastReq_CmdId = 3005
...
func (SceneWeatherForcastReq_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_SceneWeatherForcastReq_proto_enumTypes[0].Descriptor()
}

func (SceneWeatherForcastReq_CmdId) Type() protoreflect.EnumType {
	return &file_SceneWeatherForcastReq_proto_enumTypes[0]
}
...
func (SceneWeatherForcastReq_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_SceneWeatherForcastReq_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_SceneWeatherForcastReq_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa4, 0x01, 0x0a, 0x16, 0x53, 0x63, 0x65, 0x6e, 0x65, 0x57,
	0x65, 0x61, 0x74, 0x68, 0x65, 0x72, 0x46, 0x6f, 0x72, 0x63, 0x61, 0x73, 0x74, 0x52, 0x65, 0x71,
	...
	0x65, 0x72, 0x41, 0x72, 0x65, 0x61, 0x49, 0x64, 0x22, 0x62, 0x0a, 0x05, 0x43, 0x6d, 0x64, 0x49,
	0x64, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43,
	0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xbd, 0x17, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54,
...
var file_SceneWeatherForcastReq_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_SceneWeatherForcastReq_proto_goTypes = []interface{}{
	(SceneWeatherForcastReq_CmdId)(0), // 0: proto.SceneWeatherForcastReq.CmdId
	(*SceneWeatherForcastReq)(nil),    // 1: proto.SceneWeatherForcastReq
}
...
func file_SceneWeatherForcastReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_SceneWeatherForcastReq_proto_enumTypes,
