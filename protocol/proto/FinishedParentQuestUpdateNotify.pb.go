...
const (
	...
	FinishedParentQuestUpdateNotify_CMD_ID           FinishedParentQuestUpdateNotify_CmdId = 405
...
func (FinishedParentQuestUpdateNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_FinishedParentQuestUpdateNotify_proto_enumTypes[0].Descriptor()
}

func (FinishedParentQuestUpdateNotify_CmdId) Type() protoreflect.EnumType {
	return &file_FinishedParentQuestUpdateNotify_proto_enumTypes[0]
}
...
func (FinishedParentQuestUpdateNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_FinishedParentQuestUpdateNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
type FinishedParentQuestUpdateNotify struct {
	...
	ParentQuestList []*ParentQuest `protobuf:"bytes,1,rep,name=parent_quest_list,json=parentQuestList,proto3" json:"parent_quest_list,omitempty"`
}
...
var file_FinishedParentQuestUpdateNotify_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xb0, 0x01, 0x0a, 0x1f, 0x46, 0x69, 0x6e, 0x69, 0x73, 0x68, 0x65, 0x64, 0x50, 0x61,
	0x72, 0x65, 0x6e, 0x74, 0x51, 0x75, 0x65, 0x73, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4e,
	0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x3e, 0x0a, 0x11, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x5f,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x12, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x50, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x51,
	0x75, 0x65, 0x73, 0x74, 0x52, 0x0f, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x51, 0x75, 0x65, 0x73,
	...
	0x49, 0x44, 0x10, 0x95, 0x03, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f, 0x43, 0x48,
...
var file_FinishedParentQuestUpdateNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_FinishedParentQuestUpdateNotify_proto_goTypes = []interface{}{
	(FinishedParentQuestUpdateNotify_CmdId)(0), // 0: proto.FinishedParentQuestUpdateNotify.CmdId
	(*FinishedParentQuestUpdateNotify)(nil),    // 1: proto.FinishedParentQuestUpdateNotify
	(*ParentQuest)(nil),                        // 2: proto.ParentQuest
}
var file_FinishedParentQuestUpdateNotify_proto_depIdxs = []int32{
	2, // 0: proto.FinishedParentQuestUpdateNotify.parent_quest_list:type_name -> proto.ParentQuest
...
func file_FinishedParentQuestUpdateNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_FinishedParentQuestUpdateNotify_proto_enumTypes,
