...
const (
	...
	WatcherAllDataNotify_CMD_ID           WatcherAllDataNotify_CmdId = 2201
...
func (WatcherAllDataNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_WatcherAllDataNotify_proto_enumTypes[0].Descriptor()
}

func (WatcherAllDataNotify_CmdId) Type() protoreflect.EnumType {
	return &file_WatcherAllDataNotify_proto_enumTypes[0]
}
...
func (WatcherAllDataNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_WatcherAllDataNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
type WatcherAllDataNotify struct {
	...
	WatcherList []uint32 `protobuf:"varint,1,rep,packed,name=watcher_list,json=watcherList,proto3" json:"watcher_list,omitempty"`
}
...
var file_WatcherAllDataNotify_proto_rawDesc = []byte{
	...
	0x14, 0x57, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72, 0x41, 0x6c, 0x6c, 0x44, 0x61, 0x74, 0x61, 0x4e,
	0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x21, 0x0a, 0x0c, 0x77, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72,
	0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x77, 0x61, 0x74,
	0x63, 0x68, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x4d, 0x0a, 0x05, 0x43, 0x6d, 0x64, 0x49,
	0x64, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43,
	0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0x99, 0x11, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54,
...
var file_WatcherAllDataNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_WatcherAllDataNotify_proto_goTypes = []interface{}{
	(WatcherAllDataNotify_CmdId)(0), // 0: WatcherAllDataNotify.CmdId
	(*WatcherAllDataNotify)(nil),    // 1: WatcherAllDataNotify
}
...
func file_WatcherAllDataNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_WatcherAllDataNotify_proto_enumTypes,
