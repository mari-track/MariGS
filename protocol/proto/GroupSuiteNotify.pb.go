...
const (
	...
	GroupSuiteNotify_CMD_ID           GroupSuiteNotify_CmdId = 3042
...
type GroupSuiteNotify struct {
	...
	GroupMap map[uint32]uint32 `protobuf:"bytes,1,rep,name=group_map,json=groupMap,proto3" json:"group_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
var file_GroupSuiteNotify_proto_rawDesc = []byte{
	...
	0x66, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xdc, 0x01, 0x0a, 0x10, 0x47, 0x72, 0x6f,
	0x75, 0x70, 0x53, 0x75, 0x69, 0x74, 0x65, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x3c, 0x0a,
	0x09, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b,
	...
	0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xe2, 0x17, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54,
...
var file_GroupSuiteNotify_proto_goTypes = []interface{}{
	(GroupSuiteNotify_CmdId)(0), // 0: GroupSuiteNotify.CmdId
	(*GroupSuiteNotify)(nil),    // 1: GroupSuiteNotify
	nil,                         // 2: GroupSuiteNotify.GroupMapEntry
}
var file_GroupSuiteNotify_proto_depIdxs = []int32{
	2, // 0: GroupSuiteNotify.group_map:type_name -> GroupSuiteNotify.GroupMapEntry
