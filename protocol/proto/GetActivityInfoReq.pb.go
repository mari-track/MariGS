...
type GetActivityInfoReq_CmdId int32

const (
	GetActivityInfoReq_NONE             GetActivityInfoReq_CmdId = 0
	GetActivityInfoReq_CMD_ID           GetActivityInfoReq_CmdId = 2003
	GetActivityInfoReq_ENET_CHANNEL_ID  GetActivityInfoReq_CmdId = 0
	GetActivityInfoReq_ENET_IS_RELIABLE GetActivityInfoReq_CmdId = 1
	GetActivityInfoReq_IS_ALLOW_CLIENT  GetActivityInfoReq_CmdId = 1
)

// Enum value maps for GetActivityInfoReq_CmdId.
var (
	GetActivityInfoReq_CmdId_name = map[int32]string{
		0:    "NONE",
		2003: "CMD_ID",
	...
	GetActivityInfoReq_CmdId_value = map[string]int32{
		"NONE":             0,
		"CMD_ID":           2003,
		"ENET_CHANNEL_ID":  0,
		"ENET_IS_RELIABLE": 1,
...
func (x GetActivityInfoReq_CmdId) Enum() *GetActivityInfoReq_CmdId {
	p := new(GetActivityInfoReq_CmdId)
	*p = x
	return p
}

func (x GetActivityInfoReq_CmdId) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GetActivityInfoReq_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_GetActivityInfoReq_proto_enumTypes[0].Descriptor()
}

func (GetActivityInfoReq_CmdId) Type() protoreflect.EnumType {
	return &file_GetActivityInfoReq_proto_enumTypes[0]
}

func (x GetActivityInfoReq_CmdId) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GetActivityInfoReq_CmdId.Descriptor instead.
func (GetActivityInfoReq_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_GetActivityInfoReq_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_GetActivityInfoReq_proto_rawDesc = []byte{
	...
	0x6f, 0x52, 0x65, 0x71, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa2, 0x01, 0x0a, 0x12, 0x47,
	0x65, 0x74, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65,
	0x71, 0x12, 0x28, 0x0a, 0x10, 0x61, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x5f, 0x69, 0x64,
	0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0e, 0x61, 0x63, 0x74,
	0x69, 0x76, 0x69, 0x74, 0x79, 0x49, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x62, 0x0a, 0x05, 0x43,
	0x6d, 0x64, 0x49, 0x64, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0b,
	0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xd3, 0x0f, 0x12, 0x13, 0x0a, 0x0f, 0x45,
...
var file_GetActivityInfoReq_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_GetActivityInfoReq_proto_goTypes = []interface{}{
	(GetActivityInfoReq_CmdId)(0), // 0: GetActivityInfoReq.CmdId
	(*GetActivityInfoReq)(nil),    // 1: GetActivityInfoReq
}
...
func file_GetActivityInfoReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_GetActivityInfoReq_proto_enumTypes,
