...
const (
	...
	AvatarTeamUpdateNotify_CMD_ID           AvatarTeamUpdateNotify_CmdId = 1715
...
type AvatarTeamUpdateNotify struct {
	...
	AvatarTeamMap      map[uint32]*AvatarTeam `protobuf:"bytes,1,rep,name=avatar_team_map,json=avatarTeamMap,proto3" json:"avatar_team_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
var file_AvatarTeamUpdateNotify_proto_rawDesc = []byte{
	...
	0x22, 0xbd, 0x02, 0x0a, 0x16, 0x41, 0x76, 0x61, 0x74, 0x61, 0x72, 0x54, 0x65, 0x61, 0x6d, 0x55,
	0x70, 0x64, 0x61, 0x74, 0x65, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x52, 0x0a, 0x0f, 0x61,
	0x76, 0x61, 0x74, 0x61, 0x72, 0x5f, 0x74, 0x65, 0x61, 0x6d, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x01,
	...
	0x75, 0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x04, 0x52, 0x12,
...
var file_AvatarTeamUpdateNotify_proto_goTypes = []interface{}{
	(AvatarTeamUpdateNotify_CmdId)(0), // 0: AvatarTeamUpdateNotify.CmdId
	(*AvatarTeamUpdateNotify)(nil),    // 1: AvatarTeamUpdateNotify
	nil,                               // 2: AvatarTeamUpdateNotify.AvatarTeamMapEntry
	(*AvatarTeam)(nil),                // 3: AvatarTeam
}
var file_AvatarTeamUpdateNotify_proto_depIdxs = []int32{
	2, // 0: AvatarTeamUpdateNotify.avatar_team_map:type_name -> AvatarTeamUpdateNotify.AvatarTeamMapEntry
	3, // 1: AvatarTeamUpdateNotify.AvatarTeamMapEntry.value:type_name -> AvatarTeam
