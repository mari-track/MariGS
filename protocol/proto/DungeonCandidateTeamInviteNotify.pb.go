...
const (
	...
	DungeonCandidateTeamInviteNotify_CMD_ID           DungeonCandidateTeamInviteNotify_CmdId = 926
...
func (DungeonCandidateTeamInviteNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_DungeonCandidateTeamInviteNotify_proto_enumTypes[0].Descriptor()
}

func (DungeonCandidateTeamInviteNotify_CmdId) Type() protoreflect.EnumType {
	return &file_DungeonCandidateTeamInviteNotify_proto_enumTypes[0]
}
...
func (DungeonCandidateTeamInviteNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_DungeonCandidateTeamInviteNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
type DungeonCandidateTeamInviteNotify struct {
	...
	VaildDeadlineTimeSec uint32 `protobuf:"varint,3,opt,name=vaild_deadline_time_sec,json=vaildDeadlineTimeSec,proto3" json:"vaild_deadline_time_sec,omitempty"`
}
...
var file_DungeonCandidateTeamInviteNotify_proto_rawDesc = []byte{
	...
	0xe6, 0x01, 0x0a, 0x20, 0x44, 0x75, 0x6e, 0x67, 0x65, 0x6f, 0x6e, 0x43, 0x61, 0x6e, 0x64, 0x69,
	...
	0x49, 0x64, 0x12, 0x35, 0x0a, 0x17, 0x76, 0x61, 0x69, 0x6c, 0x64, 0x5f, 0x64, 0x65, 0x61, 0x64,
	0x6c, 0x69, 0x6e, 0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x73, 0x65, 0x63, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x14, 0x76, 0x61, 0x69, 0x6c, 0x64, 0x44, 0x65, 0x61, 0x64, 0x6c, 0x69,
	0x6e, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x53, 0x65, 0x63, 0x22, 0x4d, 0x0a, 0x05, 0x43, 0x6d, 0x64,
	0x49, 0x64, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x06,
	0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0x9e, 0x07, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45,
...
var file_DungeonCandidateTeamInviteNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_DungeonCandidateTeamInviteNotify_proto_goTypes = []interface{}{
	(DungeonCandidateTeamInviteNotify_CmdId)(0), // 0: proto.DungeonCandidateTeamInviteNotify.CmdId
	(*DungeonCandidateTeamInviteNotify)(nil),    // 1: proto.DungeonCandidateTeamInviteNotify
}
...
func file_DungeonCandidateTeamInviteNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_DungeonCandidateTeamInviteNotify_proto_enumTypes,
