...
type TrialAvatarInDungeonIndexNotify_CmdId int32

const (
	TrialAvatarInDungeonIndexNotify_NONE             TrialAvatarInDungeonIndexNotify_CmdId = 0
	TrialAvatarInDungeonIndexNotify_CMD_ID           TrialAvatarInDungeonIndexNotify_CmdId = 2048
	TrialAvatarInDungeonIndexNotify_ENET_CHANNEL_ID  TrialAvatarInDungeonIndexNotify_CmdId = 0
	TrialAvatarInDungeonIndexNotify_ENET_IS_RELIABLE TrialAvatarInDungeonIndexNotify_CmdId = 1
)

// Enum value maps for TrialAvatarInDungeonIndexNotify_CmdId.
var (
	TrialAvatarInDungeonIndexNotify_CmdId_name = map[int32]string{
		0:    "NONE",
		2048: "CMD_ID",
		// Duplicate value: 0: "ENET_CHANNEL_ID",
		1: "ENET_IS_RELIABLE",
	}
	TrialAvatarInDungeonIndexNotify_CmdId_value = map[string]int32{
		"NONE":             0,
		"CMD_ID":           2048,
		"ENET_CHANNEL_ID":  0,
		"ENET_IS_RELIABLE": 1,
...
func (x TrialAvatarInDungeonIndexNotify_CmdId) Enum() *TrialAvatarInDungeonIndexNotify_CmdId {
	p := new(TrialAvatarInDungeonIndexNotify_CmdId)
	*p = x
	return p
}

func (x TrialAvatarInDungeonIndexNotify_CmdId) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TrialAvatarInDungeonIndexNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_TrialAvatarInDungeonIndexNotify_proto_enumTypes[0].Descriptor()
}

func (TrialAvatarInDungeonIndexNotify_CmdId) Type() protoreflect.EnumType {
	return &file_TrialAvatarInDungeonIndexNotify_proto_enumTypes[0]
}

func (x TrialAvatarInDungeonIndexNotify_CmdId) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TrialAvatarInDungeonIndexNotify_CmdId.Descriptor instead.
func (TrialAvatarInDungeonIndexNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_TrialAvatarInDungeonIndexNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_TrialAvatarInDungeonIndexNotify_proto_rawDesc = []byte{
	...
	,
...
var file_TrialAvatarInDungeonIndexNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_TrialAvatarInDungeonIndexNotify_proto_goTypes = []interface{}{
	(TrialAvatarInDungeonIndexNotify_CmdId)(0), // 0: proto.TrialAvatarInDungeonIndexNotify.CmdId
	(*TrialAvatarInDungeonIndexNotify)(nil),    // 1: proto.TrialAvatarInDungeonIndexNotify
}
...
func file_TrialAvatarInDungeonIndexNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_TrialAvatarInDungeonIndexNotify_proto_enumTypes,
