...
const (
	...
	PlayerPropChangeReasonNotify_CMD_ID           PlayerPropChangeReasonNotify_CmdId = 1210
...
func (PlayerPropChangeReasonNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_PlayerPropChangeReasonNotify_proto_enumTypes[0].Descriptor()
}

func (PlayerPropChangeReasonNotify_CmdId) Type() protoreflect.EnumType {
	return &file_PlayerPropChangeReasonNotify_proto_enumTypes[0]
}
...
func (PlayerPropChangeReasonNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_PlayerPropChangeReasonNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
type PlayerPropChangeReasonNotify struct {
	...
	CurValue float32          `protobuf:"fixed32,3,opt,name=cur_value,json=curValue,proto3" json:"cur_value,omitempty"`
	Reason   PropChangeReason `protobuf:"varint,4,opt,name=reason,proto3,enum=PropChangeReason" json:"reason,omitempty"`
}
...
var file_PlayerPropChangeReasonNotify_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xef, 0x01, 0x0a,
	...
	0x64, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x02, 0x52, 0x08, 0x6f,
	0x6c, 0x64, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x75, 0x72, 0x5f, 0x76,
	0x61, 0x6c, 0x75, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x02, 0x52, 0x08, 0x63, 0x75, 0x72, 0x56,
	0x61, 0x6c, 0x75, 0x65, 0x12, 0x29, 0x0a, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x04,
	...
	0x10, 0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xba, 0x09, 0x12,
...
var file_PlayerPropChangeReasonNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_PlayerPropChangeReasonNotify_proto_goTypes = []interface{}{
	(PlayerPropChangeReasonNotify_CmdId)(0), // 0: PlayerPropChangeReasonNotify.CmdId
	(*PlayerPropChangeReasonNotify)(nil),    // 1: PlayerPropChangeReasonNotify
	(PropChangeReason)(0),                   // 2: PropChangeReason
}
var file_PlayerPropChangeReasonNotify_proto_depIdxs = []int32{
	2, // 0: PlayerPropChangeReasonNotify.reason:type_name -> PropChangeReason
...
func file_PlayerPropChangeReasonNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_PlayerPropChangeReasonNotify_proto_enumTypes,
