...
const (
	...
	DungeonCandidateTeamInviteRsp_CMD_ID           DungeonCandidateTeamInviteRsp_CmdId = 933
...
func (DungeonCandidateTeamInviteRsp_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_DungeonCandidateTeamInviteRsp_proto_enumTypes[0].Descriptor()
}

func (DungeonCandidateTeamInviteRsp_CmdId) Type() protoreflect.EnumType {
	return &file_DungeonCandidateTeamInviteRsp_proto_enumTypes[0]
}
...
func (DungeonCandidateTeamInviteRsp_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_DungeonCandidateTeamInviteRsp_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_DungeonCandidateTeamInviteRsp_proto_rawDesc = []byte{
	...
	0x65, 0x54, 0x65, 0x61, 0x6d, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x52, 0x73, 0x70, 0x12, 0x18,
	...
	0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xa5, 0x07, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54,
...
var file_DungeonCandidateTeamInviteRsp_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_DungeonCandidateTeamInviteRsp_proto_goTypes = []interface{}{
	(DungeonCandidateTeamInviteRsp_CmdId)(0), // 0: proto.DungeonCandidateTeamInviteRsp.CmdId
	(*DungeonCandidateTeamInviteRsp)(nil),    // 1: proto.DungeonCandidateTeamInviteRsp
}
...
func file_DungeonCandidateTeamInviteRsp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_DungeonCandidateTeamInviteRsp_proto_enumTypes,
