...
type AiThreatInfo struct {
	...
	AiThreatMap map[uint32]uint32 `protobuf:"bytes,1,rep,name=ai_threat_map,json=aiThreatMap,proto3" json:"ai_threat_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
var file_AiThreatInfo_proto_rawDesc = []byte{
	...
	0x61, 0x69, 0x5f, 0x74, 0x68, 0x72, 0x65, 0x61, 0x74, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x01, 0x20,
