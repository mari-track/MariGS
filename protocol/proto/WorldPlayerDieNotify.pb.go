...
const (
	...
	WorldPlayerDieNotify_CMD_ID           WorldPlayerDieNotify_CmdId = 287
...
type WorldPlayerDieNotify struct {
	...
	DieType          PlayerDieType `protobuf:"varint,1,opt,name=die_type,json=dieType,proto3,enum=PlayerDieType" json:"die_type,omitempty"`
...
var file_WorldPlayerDieNotify_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x88, 0x02, 0x0a, 0x14, 0x57, 0x6f, 0x72, 0x6c, 0x64, 0x50, 0x6c, 0x61, 0x79, 0x65,
	0x72, 0x44, 0x69, 0x65, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x29, 0x0a, 0x08, 0x64, 0x69,
	0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0e, 0x2e, 0x50,
	...
	0x72, 0x5f, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	0x10, 0x9f, 0x02, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f, 0x43, 0x48, 0x41, 0x4e,
...
var file_WorldPlayerDieNotify_proto_goTypes = []interface{}{
	(WorldPlayerDieNotify_CmdId)(0), // 0: WorldPlayerDieNotify.CmdId
	(*WorldPlayerDieNotify)(nil),    // 1: WorldPlayerDieNotify
	(PlayerDieType)(0),              // 2: PlayerDieType
}
var file_WorldPlayerDieNotify_proto_depIdxs = []int32{
	2, // 0: WorldPlayerDieNotify.die_type:type_name -> PlayerDieType
