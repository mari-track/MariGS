...
const (
	...
	EvtAvatarUpdateFocusNotify_CMD_ID           EvtAvatarUpdateFocusNotify_CmdId = 325
...
func (EvtAvatarUpdateFocusNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_EvtAvatarUpdateFocusNotify_proto_enumTypes[0].Descriptor()
}

func (EvtAvatarUpdateFocusNotify_CmdId) Type() protoreflect.EnumType {
	return &file_EvtAvatarUpdateFocusNotify_proto_enumTypes[0]
}
...
func (EvtAvatarUpdateFocusNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_EvtAvatarUpdateFocusNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_EvtAvatarUpdateFocusNotify_proto_rawDesc = []byte{
	...
	0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x11, 0x46, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64,
	0x54, 0x79, 0x70, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x88, 0x02, 0x0a, 0x1a, 0x45,
	...
	0x0d, 0x66, 0x6f, 0x63, 0x75, 0x73, 0x5f, 0x66, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x18, 0x03,
...
var file_EvtAvatarUpdateFocusNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_EvtAvatarUpdateFocusNotify_proto_goTypes = []interface{}{
	(EvtAvatarUpdateFocusNotify_CmdId)(0), // 0: proto.EvtAvatarUpdateFocusNotify.CmdId
	(*EvtAvatarUpdateFocusNotify)(nil),    // 1: proto.EvtAvatarUpdateFocusNotify
	(ForwardType)(0),                      // 2: proto.ForwardType
	(*Vector)(nil),                        // 3: proto.Vector
}
var file_EvtAvatarUpdateFocusNotify_proto_depIdxs = []int32{
	2, // 0: proto.EvtAvatarUpdateFocusNotify.forward_type:type_name -> proto.ForwardType
	3, // 1: proto.EvtAvatarUpdateFocusNotify.focus_forward:type_name -> proto.Vector
...
func file_EvtAvatarUpdateFocusNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_EvtAvatarUpdateFocusNotify_proto_enumTypes,
