...
const (
	...
	EvtAiSyncCombatThreatInfoNotify_CMD_ID           EvtAiSyncCombatThreatInfoNotify_CmdId = 352
...
var file_EvtAiSyncCombatThreatInfoNotify_proto_rawDesc = []byte{
	...
	0x74, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xcc, 0x02, 0x0a, 0x1f,
	...
	0x5f, 0x49, 0x44, 0x10, 0xe0, 0x02, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f, 0x43,
...
var file_EvtAiSyncCombatThreatInfoNotify_proto_goTypes = []interface{}{
	(EvtAiSyncCombatThreatInfoNotify_CmdId)(0), // 0: EvtAiSyncCombatThreatInfoNotify.CmdId
	(*EvtAiSyncCombatThreatInfoNotify)(nil),    // 1: EvtAiSyncCombatThreatInfoNotify
	nil,                                        // 2: EvtAiSyncCombatThreatInfoNotify.CombatThreatInfoMapEntry
	(*AiThreatInfo)(nil),                       // 3: AiThreatInfo
}
var file_EvtAiSyncCombatThreatInfoNotify_proto_depIdxs = []int32{
	2, // 0: EvtAiSyncCombatThreatInfoNotify.combat_threat_info_map:type_name -> EvtAiSyncCombatThreatInfoNotify.CombatThreatInfoMapEntry
	3, // 1: EvtAiSyncCombatThreatInfoNotify.CombatThreatInfoMapEntry.value:type_name -> AiThreatInfo
