...
type SeaLampContributeItemRsp_CmdId int32

const (
	SeaLampContributeItemRsp_NONE             SeaLampContributeItemRsp_CmdId = 0
	SeaLampContributeItemRsp_CMD_ID           SeaLampContributeItemRsp_CmdId = 2021
	SeaLampContributeItemRsp_ENET_CHANNEL_ID  SeaLampContributeItemRsp_CmdId = 0
	SeaLampContributeItemRsp_ENET_IS_RELIABLE SeaLampContributeItemRsp_CmdId = 1
)

// Enum value maps for SeaLampContributeItemRsp_CmdId.
var (
	SeaLampContributeItemRsp_CmdId_name = map[int32]string{
		0:    "NONE",
		2021: "CMD_ID",
		// Duplicate value: 0: "ENET_CHANNEL_ID",
		1: "ENET_IS_RELIABLE",
	}
	SeaLampContributeItemRsp_CmdId_value = map[string]int32{
		"NONE":             0,
		"CMD_ID":           2021,
		"ENET_CHANNEL_ID":  0,
		"ENET_IS_RELIABLE": 1,
...
func (x SeaLampContributeItemRsp_CmdId) Enum() *SeaLampContributeItemRsp_CmdId {
	p := new(SeaLampContributeItemRsp_CmdId)
	*p = x
	return p
}

func (x SeaLampContributeItemRsp_CmdId) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SeaLampContributeItemRsp_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_SeaLampContributeItemRsp_proto_enumTypes[0].Descriptor()
}

func (SeaLampContributeItemRsp_CmdId) Type() protoreflect.EnumType {
	return &file_SeaLampContributeItemRsp_proto_enumTypes[0]
}

func (x SeaLampContributeItemRsp_CmdId) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SeaLampContributeItemRsp_CmdId.Descriptor instead.
func (SeaLampContributeItemRsp_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_SeaLampContributeItemRsp_proto_rawDescGZIP(), []int{0, 0}
}
...
type SeaLampContributeItemRsp struct {
	...
	AddContribution   uint32 `protobuf:"varint,3,opt,name=add_contribution,json=addContribution,proto3" json:"add_contribution,omitempty"`
...
var file_SeaLampContributeItemRsp_proto_rawDesc = []byte{
	...
	0x22, 0x80, 0x02, 0x0a, 0x18, 0x53, 0x65, 0x61, 0x4c, 0x61, 0x6d, 0x70, 0x43, 0x6f, 0x6e, 0x74,
	...
	0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x2d, 0x0a, 0x12, 0x74, 0x6f, 0x74, 0x61, 0x6c,
	0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x11, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x69,
	0x62, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x29, 0x0a, 0x10, 0x61, 0x64, 0x64, 0x5f, 0x63, 0x6f,
	0x6e, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x0f, 0x61, 0x64, 0x64, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x69, 0x6f,
	...
	0x72, 0x65, 0x73, 0x73, 0x22, 0x4d, 0x0a, 0x05, 0x43, 0x6d, 0x64, 0x49, 0x64, 0x12, 0x08, 0x0a,
	0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49,
	0x44, 0x10, 0xe5, 0x0f, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f, 0x43, 0x48, 0x41,
...
var file_SeaLampContributeItemRsp_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_SeaLampContributeItemRsp_proto_goTypes = []interface{}{
	(SeaLampContributeItemRsp_CmdId)(0), // 0: SeaLampContributeItemRsp.CmdId
	(*SeaLampContributeItemRsp)(nil),    // 1: SeaLampContributeItemRsp
}
...
func file_SeaLampContributeItemRsp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_SeaLampContributeItemRsp_proto_enumTypes,
