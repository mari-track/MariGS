...
const (
	...
	SetEntityClientDataNotify_CMD_ID           SetEntityClientDataNotify_CmdId = 3041
...
func (SetEntityClientDataNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_SetEntityClientDataNotify_proto_enumTypes[0].Descriptor()
}

func (SetEntityClientDataNotify_CmdId) Type() protoreflect.EnumType {
	return &file_SetEntityClientDataNotify_proto_enumTypes[0]
}
...
func (SetEntityClientDataNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_SetEntityClientDataNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
type SetEntityClientDataNotify struct {
	...
	EntityClientData *EntityClientData `protobuf:"bytes,2,opt,name=entity_client_data,json=entityClientData,proto3" json:"entity_client_data,omitempty"`
}
...
var file_SetEntityClientDataNotify_proto_rawDesc = []byte{
	...
	0x22, 0xe3, 0x01, 0x0a, 0x19, 0x53, 0x65, 0x74, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x43, 0x6c,
	0x69, 0x65, 0x6e, 0x74, 0x44, 0x61, 0x74, 0x61, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x1b,
	0x0a, 0x09, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x08, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x49, 0x64, 0x12, 0x45, 0x0a, 0x12, 0x65,
	...
	0x74, 0x61, 0x22, 0x62, 0x0a, 0x05, 0x43, 0x6d, 0x64, 0x49, 0x64, 0x12, 0x08, 0x0a, 0x04, 0x4e,
	0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43, 0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10,
	0xe1, 0x17, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54, 0x5f, 0x43, 0x48, 0x41, 0x4e, 0x4e,
...
var file_SetEntityClientDataNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_SetEntityClientDataNotify_proto_goTypes = []interface{}{
	(SetEntityClientDataNotify_CmdId)(0), // 0: proto.SetEntityClientDataNotify.CmdId
	(*SetEntityClientDataNotify)(nil),    // 1: proto.SetEntityClientDataNotify
	(*EntityClientData)(nil),             // 2: proto.EntityClientData
}
var file_SetEntityClientDataNotify_proto_depIdxs = []int32{
	2, // 0: proto.SetEntityClientDataNotify.entity_client_data:type_name -> proto.EntityClientData
...
func file_SetEntityClientDataNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_SetEntityClientDataNotify_proto_enumTypes,
