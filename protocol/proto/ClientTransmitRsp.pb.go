...
type ClientTransmitRsp struct {
	...
	Reason  TransmitReason `protobuf:"varint,2,opt,name=reason,proto3,enum=TransmitReason" json:"reason,omitempty"`
}
...
var file_ClientTransmitRsp_proto_rawDesc = []byte{
	...
	0xa5, 0x01, 0x0a, 0x11, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x6d,
	0x69, 0x74, 0x52, 0x73, 0x70, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x12,
	0x27, 0x0a, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32,
	0x0f, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x6d, 0x69, 0x74, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e,
	...
	0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xf1, 0x01, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54,
...
var file_ClientTransmitRsp_proto_goTypes = []interface{}{
	(ClientTransmitRsp_CmdId)(0), // 0: ClientTransmitRsp.CmdId
	(*ClientTransmitRsp)(nil),    // 1: ClientTransmitRsp
	(TransmitReason)(0),          // 2: TransmitReason
}
var file_ClientTransmitRsp_proto_depIdxs = []int32{
	2, // 0: ClientTransmitRsp.reason:type_name -> TransmitReason
