...
const (
	...
	AvatarSatiationDataNotify_CMD_ID           AvatarSatiationDataNotify_CmdId = 1742
...
func (AvatarSatiationDataNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_AvatarSatiationDataNotify_proto_enumTypes[0].Descriptor()
}

func (AvatarSatiationDataNotify_CmdId) Type() protoreflect.EnumType {
	return &file_AvatarSatiationDataNotify_proto_enumTypes[0]
}
...
func (AvatarSatiationDataNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_AvatarSatiationDataNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
type AvatarSatiationDataNotify struct {
	...
	SatiationDataList []*AvatarSatiationData `protobuf:"bytes,1,rep,name=satiation_data_list,json=satiationDataList,proto3" json:"satiation_data_list,omitempty"`
}
...
var file_AvatarSatiationDataNotify_proto_rawDesc = []byte{
	...
	,
...
var file_AvatarSatiationDataNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_AvatarSatiationDataNotify_proto_goTypes = []interface{}{
	(AvatarSatiationDataNotify_CmdId)(0), // 0: proto.AvatarSatiationDataNotify.CmdId
	(*AvatarSatiationDataNotify)(nil),    // 1: proto.AvatarSatiationDataNotify
	(*AvatarSatiationData)(nil),          // 2: proto.AvatarSatiationData
}
var file_AvatarSatiationDataNotify_proto_depIdxs = []int32{
	2, // 0: proto.AvatarSatiationDataNotify.satiation_data_list:type_name -> proto.AvatarSatiationData
...
func file_AvatarSatiationDataNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_AvatarSatiationDataNotify_proto_enumTypes,
