...
const (
	...
	AddFriendNotify_CMD_ID           AddFriendNotify_CmdId = 4021
...
func (AddFriendNotify_CmdId) Descriptor() protoreflect.EnumDescriptor {
	return file_AddFriendNotify_proto_enumTypes[0].Descriptor()
}

func (AddFriendNotify_CmdId) Type() protoreflect.EnumType {
	return &file_AddFriendNotify_proto_enumTypes[0]
}
...
func (AddFriendNotify_CmdId) EnumDescriptor() ([]byte, []int) {
	return file_AddFriendNotify_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_AddFriendNotify_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xc3, 0x01, 0x0a, 0x0f, 0x41, 0x64, 0x64, 0x46, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x4e,
	0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f,
	0x75, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x74, 0x61, 0x72, 0x67, 0x65,
	0x74, 0x55, 0x69, 0x64, 0x12, 0x42, 0x0a, 0x13, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x66,
	0x72, 0x69, 0x65, 0x6e, 0x64, 0x5f, 0x62, 0x72, 0x69, 0x65, 0x66, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	0x65, 0x6e, 0x64, 0x42, 0x72, 0x69, 0x65, 0x66, 0x22, 0x4d, 0x0a, 0x05, 0x43, 0x6d, 0x64, 0x49,
	0x64, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x06, 0x43,
	0x4d, 0x44, 0x5f, 0x49, 0x44, 0x10, 0xb5, 0x1f, 0x12, 0x13, 0x0a, 0x0f, 0x45, 0x4e, 0x45, 0x54,
...
var file_AddFriendNotify_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_AddFriendNotify_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_AddFriendNotify_proto_goTypes = []interface{}{
	(AddFriendNotify_CmdId)(0), // 0: proto.AddFriendNotify.CmdId
	(*AddFriendNotify)(nil),    // 1: proto.AddFriendNotify
	(*FriendBrief)(nil),        // 2: proto.FriendBrief
}
var file_AddFriendNotify_proto_depIdxs = []int32{
	2, // 0: proto.AddFriendNotify.target_friend_brief:type_name -> proto.FriendBrief
...
func file_AddFriendNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_AddFriendNotify_proto_enumTypes,
