...
type PlayerDataBin struct {
	...
	SceneBin  *PlayerSceneCompBin  `protobuf:"bytes,7,opt,name=scene_bin,json=sceneBin,proto3" json:"scene_bin,omitempty"`    // 场景
}
...
type AvatarBin struct {
	...
	SkillMap      map[uint32]uint32 `protobuf:"bytes,10,rep,name=skill_map,json=skillMap,proto3" json:"skill_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"` // 技能
...
func (x *AvatarBin) GetSkillMap() map[uint32]uint32 {
	if x != nil {
		return x.SkillMap
	}
	return nil
...
type AvatarTeamBin struct {
	...
	AvatarIdList    []uint32 `protobuf:"varint,1,rep,packed,name=avatar_id_list,json=avatarIdList,proto3" json:"avatar_id_list,omitempty"`     // 队伍角色
	TeamName        string   `protobuf:"bytes,2,opt,name=team_name,json=teamName,proto3" json:"team_name,omitempty"`                           // 队伍名称
	LastCurAvatarId uint32   `protobuf:"varint,3,opt,name=last_cur_avatar_id,json=lastCurAvatarId,proto3" json:"last_cur_avatar_id,omitempty"` // 当前上场角色
}
...
func (x *AvatarTeamBin) GetAvatarIdList() []uint32 {
	if x != nil {
...
func (x *AvatarTeamBin) GetLastCurAvatarId() uint32 {
	if x != nil {
		return x.LastCurAvatarId
	}
	return 0
}
...
type PlayerSceneCompBin struct {
	...
	// WorldBin world = 1;
	CurSceneOwnerUid uint32             `protobuf:"varint,2,opt,name=cur_scene_owner_uid,json=curSceneOwnerUid,proto3" json:"cur_scene_owner_uid,omitempty"`   // 当前世界主人uid
	MyPrevSceneId    uint32             `protobuf:"varint,3,opt,name=my_prev_scene_id,json=myPrevSceneId,proto3" json:"my_prev_scene_id,omitempty"`            // 我的上一个场景id
	MyPrevPos        *VectorBin         `protobuf:"bytes,4,opt,name=my_prev_pos,json=myPrevPos,proto3" json:"my_prev_pos,omitempty"`                           // 我的上一个场景坐标
	MyPrevRot        *VectorBin         `protobuf:"bytes,5,opt,name=my_prev_rot,json=myPrevRot,proto3" json:"my_prev_rot,omitempty"`                           // 我的上一个场景朝向
	MyCurSceneId     uint32             `protobuf:"varint,6,opt,name=my_cur_scene_id,json=myCurSceneId,proto3" json:"my_cur_scene_id,omitempty"`               // 我的当前世界id
	MonsterSeenList  []uint32           `protobuf:"varint,7,rep,packed,name=monster_seen_list,json=monsterSeenList,proto3" json:"monster_seen_list,omitempty"` // 怪物列表
	MarkPointList    []*MapMarkPointBin `protobuf:"bytes,8,rep,name=mark_point_list,json=markPointList,proto3" json:"mark_point_list,omitempty"`               // 标记点列表
	...
	MyCurAreaId      uint32 `protobuf:"varint,15,opt,name=my_cur_area_id,json=myCurAreaId,proto3" json:"my_cur_area_id,omitempty"` // 当前区域id
	// map<uint32,DungeonProductBin> dungeon_product_map = 16; // 副本产物
	ChestOpenNumMap                                map[uint32]uint32 `protobuf:"bytes,17,rep,name=chest_open_num_map,json=chestOpenNumMap,proto3" json:"chest_open_num_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`                // 宝箱开启情况
	GadgetInteractNumMap                           map[uint32]uint32 `protobuf:"bytes,18,rep,name=gadget_interact_num_map,json=gadgetInteractNumMap,proto3" json:"gadget_interact_num_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"` // gadget 交互情况
	TotalBossChestTakeNum                          uint32            `protobuf:"varint,19,opt,name=total_boss_chest_take_num,json=totalBossChestTakeNum,proto3" json:"total_boss_chest_take_num,omitempty"`                                                                                     // 全部大宝箱开启情况？
	...
	LastRefreshDailyGadgetDropCategoryCountMapTime uint32            `protobuf:"varint,21,opt,name=last_refresh_daily_gadget_drop_category_count_map_time,json=lastRefreshDailyGadgetDropCategoryCountMapTime,proto3" json:"last_refresh_daily_gadget_drop_category_count_map_time,omitempty"` // 每日小道具刷新？
	// repeated MonsterBeKilledNumBin monster_killed_num_list = 22;
	MyCurPos *VectorBin `protobuf:"bytes,23,opt,name=my_cur_pos,json=myCurPos,proto3" json:"my_cur_pos,omitempty"` // 当前数据库坐标
	MyCurRot *VectorBin `protobuf:"bytes,24,opt,name=my_cur_rot,json=myCurRot,proto3" json:"my_cur_rot,omitempty"` // 当前数据库朝向
}
...
func (x *PlayerSceneCompBin) GetMyCurPos() *VectorBin {
	if x != nil {
		return x.MyCurPos
	}
	return nil
...
func (x *PlayerSceneCompBin) GetMyCurRot() *VectorBin {
	if x != nil {
		return x.MyCurRot
	}
	return nil
...
var file_bin_server_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xd7, 0x01, 0x0a, 0x0d, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x44, 0x61, 0x74,
	...
	0x6e, 0x52, 0x07, 0x69, 0x74, 0x65, 0x6d, 0x42, 0x69, 0x6e, 0x12, 0x30, 0x0a, 0x09, 0x73, 0x63,
	0x65, 0x6e, 0x65, 0x5f, 0x62, 0x69, 0x6e, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e,
	0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x53, 0x63, 0x65, 0x6e, 0x65, 0x43, 0x6f, 0x6d, 0x70, 0x42,
	0x69, 0x6e, 0x52, 0x08, 0x73, 0x63, 0x65, 0x6e, 0x65, 0x42, 0x69, 0x6e, 0x22, 0xce, 0x0b, 0x0a,
	...
	,
	...
	0x63, 0x65, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x14, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x63,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x4a, 0x0a, 0x0c, 0x54, 0x65, 0x61, 0x6d, 0x4d, 0x61, 0x70,
	0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x24, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x41, 0x76, 0x61, 0x74, 0x61, 0x72, 0x54,
	0x65, 0x61, 0x6d, 0x42, 0x69, 0x6e, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38,
	0x01, 0x22, 0xc9, 0x06, 0x0a, 0x09, 0x41, 0x76, 0x61, 0x74, 0x61, 0x72, 0x42, 0x69, 0x6e, 0x12,
	...
	,
	...
	0x0d, 0x41, 0x76, 0x61, 0x74, 0x61, 0x72, 0x54, 0x65, 0x61, 0x6d, 0x42, 0x69, 0x6e, 0x12, 0x24,
	0x0a, 0x0e, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x5f, 0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0c, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x49, 0x64,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x28, 0x0d, 0x52, 0x03, 0x65, 0x78, 0x70, 0x12, 0x20, 0x0a, 0x0c, 0x6d, 0x61, 0x69, 0x6e, 0x5f,
	0x70, 0x72, 0x6f, 0x70, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x6d,
	0x61, 0x69, 0x6e, 0x50, 0x72, 0x6f, 0x70, 0x49, 0x64, 0x12, 0x2d, 0x0a, 0x13, 0x61, 0x70, 0x70,
	0x65, 0x6e, 0x64, 0x5f, 0x70, 0x72, 0x6f, 0x70, 0x5f, 0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74,
	0x18, 0x05, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x10, 0x61, 0x70, 0x70, 0x65, 0x6e, 0x64, 0x50, 0x72,
	0x6f, 0x70, 0x49, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x22, 0xd3, 0x02, 0x0a, 0x09, 0x57, 0x65, 0x61,
	0x70, 0x6f, 0x6e, 0x42, 0x69, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x18,
	...
	,
	...
	,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x52, 0x0a, 0x24, 0x44, 0x61, 0x69, 0x6c, 0x79,
	0x47, 0x61, 0x64, 0x67, 0x65, 0x74, 0x44, 0x72, 0x6f, 0x70, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f,
	0x72, 0x79, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x4d, 0x61, 0x70, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12,
	0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65,
	0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xd4, 0x01, 0x0a, 0x0f,
	...
	,
	...
	,
...
var file_bin_server_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_bin_server_proto_goTypes = []interface{}{
	...
	(*AvatarSkillDepotBin)(nil), // 6: AvatarSkillDepotBin
	(*VectorBin)(nil),           // 7: VectorBin
	(*PlayerItemCompBin)(nil),   // 8: PlayerItemCompBin
	(*AutoRecoverItemBin)(nil),  // 9: AutoRecoverItemBin
	(*ReliquaryBin)(nil),        // 10: ReliquaryBin
	(*WeaponBin)(nil),           // 11: WeaponBin
	(*PlayerSceneCompBin)(nil),  // 12: PlayerSceneCompBin
	(*MapMarkPointBin)(nil),     // 13: MapMarkPointBin
	(*PlayerData)(nil),          // 14: PlayerData
	nil,                         // 15: PlayerBasicCompBin.OpenStateMapEntry
	nil,                         // 16: PlayerBasicCompBin.PropMapEntry
	nil,                         // 17: PlayerAvatarCompBin.AvatarListEntry
	nil,                         // 18: PlayerAvatarCompBin.TeamMapEntry
	...
	nil,                         // 26: PlayerSceneCompBin.ChestOpenNumMapEntry
	nil,                         // 27: PlayerSceneCompBin.GadgetInteractNumMapEntry
	nil,                         // 28: PlayerSceneCompBin.DailyGadgetDropCategoryCountMapEntry
}
var file_bin_server_proto_depIdxs = []int32{
	...
	8,  // 2: PlayerDataBin.item_bin:type_name -> PlayerItemCompBin
	12, // 3: PlayerDataBin.scene_bin:type_name -> PlayerSceneCompBin
	15, // 4: PlayerBasicCompBin.open_state_map:type_name -> PlayerBasicCompBin.OpenStateMapEntry
	16, // 5: PlayerBasicCompBin.prop_map:type_name -> PlayerBasicCompBin.PropMapEntry
	17, // 6: PlayerAvatarCompBin.avatar_list:type_name -> PlayerAvatarCompBin.AvatarListEntry
	18, // 7: PlayerAvatarCompBin.team_map:type_name -> PlayerAvatarCompBin.TeamMapEntry
	19, // 8: AvatarBin.skill_map:type_name -> AvatarBin.SkillMapEntry
	20, // 9: AvatarBin.fight_prop_map:type_name -> AvatarBin.FightPropMapEntry
	21, // 10: AvatarSkillDepotBin.skill_level_map:type_name -> AvatarSkillDepotBin.SkillLevelMapEntry
	22, // 11: PlayerItemCompBin.item_list:type_name -> PlayerItemCompBin.ItemListEntry
	9,  // 12: PlayerItemCompBin.resin_record:type_name -> AutoRecoverItemBin
	23, // 13: PlayerItemCompBin.reliquary_list:type_name -> PlayerItemCompBin.ReliquaryListEntry
	24, // 14: PlayerItemCompBin.weapon_list:type_name -> PlayerItemCompBin.WeaponListEntry
	25, // 15: WeaponBin.affix_map:type_name -> WeaponBin.AffixMapEntry
	7,  // 16: PlayerSceneCompBin.my_prev_pos:type_name -> VectorBin
	7,  // 17: PlayerSceneCompBin.my_prev_rot:type_name -> VectorBin
	13, // 18: PlayerSceneCompBin.mark_point_list:type_name -> MapMarkPointBin
	26, // 19: PlayerSceneCompBin.chest_open_num_map:type_name -> PlayerSceneCompBin.ChestOpenNumMapEntry
	27, // 20: PlayerSceneCompBin.gadget_interact_num_map:type_name -> PlayerSceneCompBin.GadgetInteractNumMapEntry
	28, // 21: PlayerSceneCompBin.daily_gadget_drop_category_count_map:type_name -> PlayerSceneCompBin.DailyGadgetDropCategoryCountMapEntry
	7,  // 22: PlayerSceneCompBin.my_cur_pos:type_name -> VectorBin
	7,  // 23: PlayerSceneCompBin.my_cur_rot:type_name -> VectorBin
	7,  // 24: MapMarkPointBin.pos:type_name -> VectorBin
	3,  // 25: PlayerAvatarCompBin.AvatarListEntry.value:type_name -> AvatarBin
	4,  // 26: PlayerAvatarCompBin.TeamMapEntry.value:type_name -> AvatarTeamBin
	10, // 27: PlayerItemCompBin.ReliquaryListEntry.value:type_name -> ReliquaryBin
	11, // 28: PlayerItemCompBin.WeaponListEntry.value:type_name -> WeaponBin
